...
namespace Krearthur.GOP
{
    ...
    public class GOPainter : MonoBehaviour
    {
        ...
        {
            if (brushPrefab is null) throw new System.NotSupportedException("Select brush prefab is null.");

            circleBrush = (GameObject)PrefabUtility.InstantiatePrefab(brushPrefab) as GameObject;
