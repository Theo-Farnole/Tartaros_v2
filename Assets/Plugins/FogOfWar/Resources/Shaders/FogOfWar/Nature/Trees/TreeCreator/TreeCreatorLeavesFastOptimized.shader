...
Shader "Hidden/UFoW/Nature/Tree Creator Leaves Fast Optimized" {
Properties {
...
SubShader {
    ...
    CGPROGRAM
        ...
        fixed4 FragmentLeaf (v2f_leaf IN) : SV_Target
        {
            ...
            fixed4 col = fixed4 (albedo.rgb * FoW.rgb * light, 0.0);
...
Dependency "BillboardShader" = "Hidden/UFoW/Nature/Tree Creator Leaves Rendertex"
}
