...
Shader "UFoW/Nature/SpeedTree Billboard"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            #define ENABLE_WIND
            #include "../UFoW-SpeedTreeBillboardCommon.cginc"
        ...
        Pass
        {
            ...
            CGPROGRAM
                ...
                {
                    SpeedTreeFragOut o;
					fixed4 FoW = FoWIntensity(i.data.worldPos);
                    SpeedTreeFrag(i.data, o);
                    UNITY_APPLY_DITHER_CROSSFADE(i.vertex.xy);
                    fixed4 c = fixed4(o.Albedo*FoW.rgb, o.Alpha);
