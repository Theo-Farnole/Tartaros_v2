...
Shader "UFoW/Terrain/Standard" {
    ...
    SubShader {
        ...
        #include "../UFoW-TerrainSplatmapCommon.cginc"
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            o.Albedo = mixedDiffuse.rgb * FoW.rgb;
            o.Alpha = weight;
            o.Smoothness = mixedDiffuse.a * FoW.a;
            o.Metallic = dot(splat_control, half4(_Metallic0, _Metallic1, _Metallic2, _Metallic3)) * FoW.a;
        }
        ENDCG
    }

    Dependency "AddPassShader" = "Hidden/TerrainEngine/Splatmap/UFoW-Standard-AddPass"
    Dependency "BaseMapShader" = "Hidden/TerrainEngine/Splatmap/UFoW-Standard-Base"
