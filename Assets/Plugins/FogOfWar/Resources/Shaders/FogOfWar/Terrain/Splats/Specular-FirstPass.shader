...
Shader "UFoW/Terrain/Specular" {
    ...
    SubShader {
        ...
        void surf(Input IN, inout SurfaceOutput o)
        {
            ...
            o.Alpha = weight;
            o.Gloss = mixedDiffuse.a * FoW.a;
            o.Specular = _Shininess * FoW.a;
        }
        ENDCG
    }

    Dependency "AddPassShader" = "Hidden/TerrainEngine/Splatmap/UFoW-Specular-AddPass"
    Dependency "BaseMapShader" = "Hidden/TerrainEngine/Splatmap/UFoW-Specular-Base"
