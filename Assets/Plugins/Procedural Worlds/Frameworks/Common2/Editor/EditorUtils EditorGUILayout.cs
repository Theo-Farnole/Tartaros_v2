...
namespace PWCommon2
{
    ...
    public partial class EditorUtils
    {
        ...
        /// </returns>
        public int Popup(int selectedIndex, string[] optionsKeys, params GUILayoutOption[] options)
        {
            var val = EditorGUILayout.Popup(selectedIndex, GetContent(optionsKeys), options);
            return val;
        }
