...
namespace PWCommon2.Localization
{
    ...
    public static class Culture
    {
        ...
        public static LanguagePack GetLanguagePackOrDefault(string localisationFolder, string className)
        {
            LanguagePack langPack = EditorLanguagePack.Load(localisationFolder, className, Language);

            if (langPack == null)
            {
                langPack = EditorLanguagePack.Load(localisationFolder, className, DEFAULT_LANGUAGE);
