Shader "CTS/CTS Terrain Shader Advanced Tess CutOut Mesh"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float3 break8119 = ase_worldPos;
			float2 appendResult8057 = (half2(break8119.x , break8119.z));
			half2 Top_Bottom1999 = appendResult8057;
			...
			float2 appendResult8055 = (half2(break8119.z , break8119.y));
			half2 Front_Back1991 = appendResult8055;
			...
			float2 appendResult8056 = (half2(break8119.x , break8119.y));
			...
			float simplePerlin2D8121 = snoise( ( Top_Bottom1999 * _Snow_Noise_Tiling ) );
			float lerpResult4310 = lerp( 1.0 , simplePerlin2D8121 , ( _Snow_Noise_Power * 0.1 ));
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult11_g1213 = (half2(texArray6256.w , texArray6256.y));
			float2 temp_output_4_0_g1213 = ( ( ( appendResult11_g1213 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float2 appendResult11_g1214 = (half2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g1214 = ( ( ( appendResult11_g1214 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			...
			float clampResult297 = clamp( pow( ( max( max( break8028.x , break8028.y ) , break8028.z ) / _UV_Mix_Start_Distance ) , _UV_Mix_Power ) , 0.0 , 1.0 );
			half UVmixDistance636 = clampResult297;
			float3 lerpResult6257 = lerp( appendResult20_g1213 , appendResult20_g1214 , UVmixDistance636);
			...
			float2 appendResult11_g585 = (half2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g585 = ( ( ( appendResult11_g585 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1.0 ) );
			float2 break8_g585 = temp_output_4_0_g585;
			float dotResult5_g585 = dot( temp_output_4_0_g585 , temp_output_4_0_g585 );
			float temp_output_9_0_g585 = sqrt( ( 1.0 - saturate( dotResult5_g585 ) ) );
			float3 appendResult21_g585 = (half3(break8_g585.y , break8_g585.x , temp_output_9_0_g585));
			...
			float2 appendResult11_g580 = (half2(texArray3301.w , texArray3301.y));
			float2 temp_output_4_0_g580 = ( ( ( appendResult11_g580 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			float2 break8_g580 = temp_output_4_0_g580;
			float dotResult5_g580 = dot( temp_output_4_0_g580 , temp_output_4_0_g580 );
			float temp_output_9_0_g580 = sqrt( ( 1.0 - saturate( dotResult5_g580 ) ) );
			float3 appendResult20_g580 = (half3(break8_g580.x , break8_g580.y , temp_output_9_0_g580));
			float3 appendResult6860 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6393 = BlendComponents91;
			float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult21_g585 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult20_g580 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
			...
			float2 appendResult11_g1141 = (half2(texArray3350.w , texArray3350.y));
			float2 temp_output_4_0_g1141 = ( ( ( appendResult11_g1141 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			...
			float3 appendResult20_g1141 = (half3(break8_g1141.x , break8_g1141.y , temp_output_9_0_g1141));
			float3 temp_output_6992_0 = appendResult20_g1141;
			float4 texArray3384 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3344_0, _Texture_2_Normal_Index)  );
			float2 appendResult11_g582 = (half2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g582 = ( ( ( appendResult11_g582 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1.0 ) );
			float2 break8_g582 = temp_output_4_0_g582;
			float dotResult5_g582 = dot( temp_output_4_0_g582 , temp_output_4_0_g582 );
			float temp_output_9_0_g582 = sqrt( ( 1.0 - saturate( dotResult5_g582 ) ) );
			float3 appendResult21_g582 = (half3(break8_g582.y , break8_g582.x , temp_output_9_0_g582));
			...
			float2 appendResult11_g581 = (half2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g581 = ( ( ( appendResult11_g581 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float2 break8_g581 = temp_output_4_0_g581;
			float dotResult5_g581 = dot( temp_output_4_0_g581 , temp_output_4_0_g581 );
			float temp_output_9_0_g581 = sqrt( ( 1.0 - saturate( dotResult5_g581 ) ) );
			float3 appendResult20_g581 = (half3(break8_g581.x , break8_g581.y , temp_output_9_0_g581));
			float3 appendResult6867 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6401 = BlendComponents91;
			float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult21_g582 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult20_g581 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
			...
			float2 appendResult11_g1142 = (half2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g1142 = ( ( ( appendResult11_g1142 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 appendResult20_g1142 = (half3(break8_g1142.x , break8_g1142.y , temp_output_9_0_g1142));
			float3 temp_output_6995_0 = appendResult20_g1142;
			float4 texArray3445 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3411_0, _Texture_3_Normal_Index)  );
			float2 appendResult11_g584 = (half2(texArray3445.w , texArray3445.y));
			float2 temp_output_4_0_g584 = ( ( ( appendResult11_g584 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1.0 ) );
			float2 break8_g584 = temp_output_4_0_g584;
			float dotResult5_g584 = dot( temp_output_4_0_g584 , temp_output_4_0_g584 );
			float temp_output_9_0_g584 = sqrt( ( 1.0 - saturate( dotResult5_g584 ) ) );
			float3 appendResult21_g584 = (half3(break8_g584.y , break8_g584.x , temp_output_9_0_g584));
			...
			float2 appendResult11_g583 = (half2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g583 = ( ( ( appendResult11_g583 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			float2 break8_g583 = temp_output_4_0_g583;
			float dotResult5_g583 = dot( temp_output_4_0_g583 , temp_output_4_0_g583 );
			float temp_output_9_0_g583 = sqrt( ( 1.0 - saturate( dotResult5_g583 ) ) );
			float3 appendResult20_g583 = (half3(break8_g583.x , break8_g583.y , temp_output_9_0_g583));
			float3 appendResult6874 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6408 = BlendComponents91;
			float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult21_g584 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult20_g583 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
			...
			float2 appendResult11_g1139 = (half2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g1139 = ( ( ( appendResult11_g1139 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult20_g1139 = (half3(break8_g1139.x , break8_g1139.y , temp_output_9_0_g1139));
			float3 temp_output_6998_0 = appendResult20_g1139;
			float4 texArray3512 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3478_0, _Texture_4_Normal_Index)  );
			float2 appendResult11_g578 = (half2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g578 = ( ( ( appendResult11_g578 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1.0 ) );
			float2 break8_g578 = temp_output_4_0_g578;
			float dotResult5_g578 = dot( temp_output_4_0_g578 , temp_output_4_0_g578 );
			float temp_output_9_0_g578 = sqrt( ( 1.0 - saturate( dotResult5_g578 ) ) );
			float3 appendResult21_g578 = (half3(break8_g578.y , break8_g578.x , temp_output_9_0_g578));
			...
			float2 appendResult11_g579 = (half2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g579 = ( ( ( appendResult11_g579 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			float2 break8_g579 = temp_output_4_0_g579;
			float dotResult5_g579 = dot( temp_output_4_0_g579 , temp_output_4_0_g579 );
			float temp_output_9_0_g579 = sqrt( ( 1.0 - saturate( dotResult5_g579 ) ) );
			float3 appendResult20_g579 = (half3(break8_g579.x , break8_g579.y , temp_output_9_0_g579));
			float3 appendResult6881 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6415 = BlendComponents91;
			float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult21_g578 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult20_g579 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
			...
			float2 appendResult11_g1176 = (half2(texArray4424.w , texArray4424.y));
			...
			float3 temp_output_7001_0 = appendResult20_g1176;
			float4 texArray4417 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4400_0, _Texture_5_Normal_Index)  );
			float2 appendResult11_g1147 = (half2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g1147 = ( ( ( appendResult11_g1147 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1.0 ) );
			...
			float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult21_g1147 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult20_g1150 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
			...
			float2 appendResult11_g1170 = (half2(texArray4493.w , texArray4493.y));
			...
			float3 temp_output_7004_0 = appendResult20_g1170;
			...
			float2 appendResult11_g1149 = (half2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g1149 = ( ( ( appendResult11_g1149 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 appendResult20_g1149 = (half3(break8_g1149.x , break8_g1149.y , temp_output_9_0_g1149));
			float3 appendResult6895 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6429 = BlendComponents91;
			float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult21_g1148 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult20_g1149 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
			...
			float2 appendResult11_g1146 = (half2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g1146 = ( ( ( appendResult11_g1146 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1146 = (half3(break8_g1146.y , break8_g1146.x , temp_output_9_0_g1146));
			...
			float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult21_g1146 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult20_g1145 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
			...
			float2 appendResult11_g1173 = (half2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g1173 = ( ( ( appendResult11_g1173 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 appendResult20_g1173 = (half3(break8_g1173.x , break8_g1173.y , temp_output_9_0_g1173));
			float3 temp_output_7010_0 = appendResult20_g1173;
			float4 texArray4634 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4620_0, _Texture_8_Normal_Index)  );
			float2 appendResult11_g1140 = (half2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g1140 = ( ( ( appendResult11_g1140 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1140 = (half3(break8_g1140.y , break8_g1140.x , temp_output_9_0_g1140));
			...
			float2 appendResult11_g1143 = (half2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g1143 = ( ( ( appendResult11_g1143 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 appendResult20_g1143 = (half3(break8_g1143.x , break8_g1143.y , temp_output_9_0_g1143));
			float3 appendResult6909 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6443 = BlendComponents91;
			float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult21_g1140 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult20_g1143 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
			...
			float2 appendResult11_g1206 = (half2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g1206 = ( ( ( appendResult11_g1206 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 temp_output_7034_0 = appendResult20_g1206;
			float4 texArray5285 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4706_0, _Texture_9_Normal_Index)  );
			float2 appendResult11_g1179 = (half2(texArray5285.w , texArray5285.y));
			float2 temp_output_4_0_g1179 = ( ( ( appendResult11_g1179 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1179 = (half3(break8_g1179.y , break8_g1179.x , temp_output_9_0_g1179));
			...
			float2 appendResult11_g1171 = (half2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g1171 = ( ( ( appendResult11_g1171 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult21_g1179 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult20_g1171 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
			...
			float2 appendResult11_g1204 = (half2(texArray4822.w , texArray4822.y));
			...
			float3 temp_output_7031_0 = appendResult20_g1204;
			float4 texArray4798 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4742_0, _Texture_10_Normal_Index)  );
			float2 appendResult11_g1172 = (half2(texArray4798.w , texArray4798.y));
			float2 temp_output_4_0_g1172 = ( ( ( appendResult11_g1172 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1172 = (half3(break8_g1172.y , break8_g1172.x , temp_output_9_0_g1172));
			...
			float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult21_g1172 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult20_g1175 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
			...
			float2 appendResult11_g1201 = (half2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g1201 = ( ( ( appendResult11_g1201 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 temp_output_7028_0 = appendResult20_g1201;
			float4 texArray4828 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4748_0, _Texture_11_Normal_Index)  );
			float2 appendResult11_g1174 = (half2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g1174 = ( ( ( appendResult11_g1174 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1.0 ) );
			...
			float2 appendResult11_g1177 = (half2(texArray4811.w , texArray4811.y));
			...
			float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult21_g1174 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult20_g1177 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
			...
			float2 appendResult11_g1202 = (half2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g1202 = ( ( ( appendResult11_g1202 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 temp_output_7025_0 = appendResult20_g1202;
			float4 texArray4850 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4758_0, _Texture_12_Normal_Index)  );
			float2 appendResult11_g1181 = (half2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g1181 = ( ( ( appendResult11_g1181 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1181 = (half3(break8_g1181.y , break8_g1181.x , temp_output_9_0_g1181));
			...
			float2 appendResult11_g1180 = (half2(texArray4852.w , texArray4852.y));
			float2 temp_output_4_0_g1180 = ( ( ( appendResult11_g1180 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult21_g1181 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult20_g1180 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
			...
			float2 appendResult11_g1210 = (half2(texArray5120.w , texArray5120.y));
			...
			float2 appendResult11_g1203 = (half2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g1203 = ( ( ( appendResult11_g1203 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1.0 ) );
			...
			float2 appendResult11_g1200 = (half2(texArray5109.w , texArray5109.y));
			float2 temp_output_4_0_g1200 = ( ( ( appendResult11_g1200 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult21_g1203 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult20_g1200 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
			...
			float2 appendResult11_g1211 = (half2(texArray5178.w , texArray5178.y));
			...
			float2 appendResult11_g1196 = (half2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g1196 = ( ( ( appendResult11_g1196 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1.0 ) );
			...
			float2 appendResult11_g1197 = (half2(texArray5170.w , texArray5170.y));
			float2 temp_output_4_0_g1197 = ( ( ( appendResult11_g1197 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 appendResult20_g1197 = (half3(break8_g1197.x , break8_g1197.y , temp_output_9_0_g1197));
			float3 appendResult6930 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6485 = BlendComponents91;
			float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult21_g1196 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult20_g1197 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
			...
			float2 appendResult11_g1209 = (half2(texArray5246.w , texArray5246.y));
			...
			float3 temp_output_7016_0 = appendResult20_g1209;
			float4 texArray5227 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5213_0, _Texture_15_Normal_Index)  );
			float2 appendResult11_g1199 = (half2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g1199 = ( ( ( appendResult11_g1199 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1199 = (half3(break8_g1199.y , break8_g1199.x , temp_output_9_0_g1199));
			...
			float2 appendResult11_g1205 = (half2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g1205 = ( ( ( appendResult11_g1205 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult21_g1199 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult20_g1205 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
			...
			float2 appendResult11_g1198 = (half2(texArray4731.w , texArray4731.y));
			float2 temp_output_4_0_g1198 = ( ( ( appendResult11_g1198 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 appendResult20_g1198 = (half3(break8_g1198.x , break8_g1198.y , temp_output_9_0_g1198));
			float3 appendResult6916 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6499 = BlendComponents91;
			float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult21_g1207 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult20_g1198 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
			...
			float2 appendResult11_g1212 = (half2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g1212 = ( ( ( appendResult11_g1212 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			...
			if( _Texture_Snow_Normal_Index <= 0.0 )
				...
				ifLocalVar7819 = appendResult20_g1212;
			...
			float temp_output_8073_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression8069 * 10.0 ) + ( break8068.x + break8068.y + break8068.z ) ) );
			float temp_output_8076_0 = ( 0.0 + temp_output_8073_0 );
			float clampResult8088 = clamp( sin( ( temp_output_8076_0 * 0.1 ) ) , 0.0 , 1.0 );
			float2 temp_output_8079_0 = ( Top_Bottom1999 * ( 1.0 / _Glitter_Tiling ) );
			float2 break8112 = temp_output_8079_0;
			float2 appendResult8111 = (half2(break8112.y , break8112.x));
			half4 tex2DNode8090 = tex2D( _Texture_Glitter, ( appendResult8111 + float2( 0.37,0.67 ) ) );
			float2 panner8080 = ( ( temp_output_8073_0 * 0.01 ) * float2( 1,1 ) + temp_output_8079_0);
			...
			float clampResult8092 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator8082 + temp_output_8079_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0.0 , 1.0 );
			float lerpResult8093 = lerp(  ( clampResult8088 - 0.2 > 0.0 ? tex2D( _Texture_Glitter, temp_output_8079_0 ).r : clampResult8088 - 0.2 <= 0.0 && clampResult8088 + 0.2 >= 0.0 ? tex2DNode8090.r : tex2DNode8090.r )  , 0.6 , clampResult8092);
			float clampResult8095 = clamp( pow( lerpResult8093 , 100.0 ) , 0.0 , 1.0 );
			...
			float clampResult8097 = clamp( temp_output_8096_0 , 0.0 , 1.0 );
			...
			float lerpResult8098 = lerp( break1409.w , _Glitter_Smoothness , clampResult8097);
			float lerpResult3951 = lerp( ( break3856.w * _Terrain_Smoothness ) , lerpResult8098 , HeightMask6539);
