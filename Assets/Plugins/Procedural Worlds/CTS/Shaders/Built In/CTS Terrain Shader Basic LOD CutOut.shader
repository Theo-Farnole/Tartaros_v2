Shader "CTS/CTS Terrain Shader Basic LOD CutOut"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult6176 = (half2(break6186.x , break6186.z));
			...
			float clampResult6195 = clamp( simplePerlin2D6191 , 0.0 , 1.0 );
			float lerpResult6192 = lerp( 1.0 , clampResult6195 ,  _Snow_Noise_Power);
			...
			float2 appendResult6159 = (half2(1.0 , ( _Global_Color_Map_Far_Power * clampResult6182 )));
			...
			clip( ( tex2D( _TerrainHolesTexture, uv_TerrainHolesTexture ).r * clampResult6167 ) - _Cutoff );
