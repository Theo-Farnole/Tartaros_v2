Shader "CTS/URP/CTS Terrain Shader Advanced LOD"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v  )
        	{
				...
				float3 localCalculateTangentsSRP7765 = ( ( v.ase_tangent.xyz * 0.0 ) );
				...
				float3 vertexValue = localCalculateTangentsSRP7765;
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float3 break7753 = WorldSpacePosition;
