Shader "CTS/URP/CTS Terrain Shader Advanced LOD CutOut"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v  )
        	{
				...
				float3 localCalculateTangentsSRP7770 = ( ( v.ase_tangent.xyz * 0.0 ) );
				...
				float3 vertexValue = localCalculateTangentsSRP7770;
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float2 appendResult7710 = (float2(1.0 , ( _Global_Color_Map_Far_Power * clampResult7751 )));
				float3 break7756 = WorldSpacePosition;
				float2 appendResult7743 = (float2(break7756.x , break7756.z));
				...
				float clampResult7733 = clamp( ( WorldSpacePosition.y + ( 0.0 - _Remove_Vert_Height ) ) , 0.0 , 1.0 );
				...
				float Occlusion = staticSwitch7703;
				float Alpha = ( tex2D( _TerrainHolesTexture, uv_TerrainHolesTexture ).r * clampResult7733 );
