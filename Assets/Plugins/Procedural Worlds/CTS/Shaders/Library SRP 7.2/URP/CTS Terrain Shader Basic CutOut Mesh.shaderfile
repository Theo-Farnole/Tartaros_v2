Shader "CTS/URP/CTS Terrain Shader Basic CutOut Mesh"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Tags { "RenderPipeline"="Universal" "RenderType"="Opaque" "Queue"="Geometry" }
        ...
        Pass
        {
			...
			inline half MyCustomExpression6278( inout half3 In0 )
			{
    ...
    o.shadowCoord = GetShadowCoord(vertexInput);
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float clampResult6325 = clamp( ( tex2DNode6204.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0.0 , 1.0 );
				float2 appendResult6241 = (float2(1.0 , ( lerpResult6230 * clampResult6325 )));
				...
				float3 break6328 = WorldSpacePosition;
				float2 appendResult6266 = (float2(break6328.x , break6328.z));
				half2 Top_Bottom1999 = appendResult6266;
				...
				float2 appendResult6264 = (float2(break6328.z , break6328.y));
				half2 Front_Back1991 = appendResult6264;
				...
				float2 appendResult6265 = (float2(break6328.x , break6328.y));
				half2 Left_Right2003 = appendResult6265;
				...
				half3 In06278 = float3( 0,0,0 );
				half localMyCustomExpression6278 = MyCustomExpression6278( In06278 );
				float3 break6277 = _WorldSpaceCameraPos;
				float temp_output_6282_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression6278 * 10.0 ) + ( break6277.x + break6277.y + break6277.z ) ) );
				float temp_output_6285_0 = ( 0.0 + temp_output_6282_0 );
				float clampResult6297 = clamp( sin( ( temp_output_6285_0 * 0.1 ) ) , 0.0 , 1.0 );
				float2 temp_output_6288_0 = ( Top_Bottom1999 * ( 1.0 / _Glitter_Tiling ) );
				float2 break6321 = temp_output_6288_0;
				float2 appendResult6320 = (float2(break6321.y , break6321.x));
				float4 tex2DNode6299 = tex2D( _Texture_Glitter, ( appendResult6320 + float2( 0.37,0.67 ) ) );
				float2 panner6289 = ( ( temp_output_6282_0 * 0.01 ) * float2( 1,1 ) + temp_output_6288_0);
				...
				float clampResult6301 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator6291 + temp_output_6288_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0.0 , 1.0 );
				float lerpResult6302 = lerp(  ( clampResult6297 - 0.2 > 0.0 ? tex2D( _Texture_Glitter, temp_output_6288_0 ).r : clampResult6297 - 0.2 <= 0.0 && clampResult6297 + 0.2 >= 0.0 ? tex2DNode6299.r : tex2DNode6299.r )  , 0.6 , clampResult6301);
				float clampResult6304 = clamp( pow( lerpResult6302 , 100.0 ) , 0.0 , 1.0 );
				...
				float2 appendResult11_g1003 = (float2(texArray3300.w , texArray3300.y));
				float2 temp_output_4_0_g1003 = ( ( ( appendResult11_g1003 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
				float2 break8_g1003 = temp_output_4_0_g1003;
				...
				float3 appendResult20_g1003 = (float3(break8_g1003.x , break8_g1003.y , temp_output_9_0_g1003));
				float3 temp_output_6001_0 = appendResult20_g1003;
				...
				float2 appendResult11_g809 = (float2(texArray3299.w , texArray3299.y));
				float2 temp_output_4_0_g809 = ( ( ( appendResult11_g809 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g809 = (float3(break8_g809.y , break8_g809.x , temp_output_9_0_g809));
				...
				float2 appendResult11_g813 = (float2(texArray3301.w , texArray3301.y));
				float2 temp_output_4_0_g813 = ( ( ( appendResult11_g813 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
				float2 break8_g813 = temp_output_4_0_g813;
				float dotResult5_g813 = dot( temp_output_4_0_g813 , temp_output_4_0_g813 );
				float temp_output_9_0_g813 = sqrt( ( 1.0 - saturate( dotResult5_g813 ) ) );
				float3 appendResult20_g813 = (float3(break8_g813.x , break8_g813.y , temp_output_9_0_g813));
				float3 appendResult5876 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5676 = BlendComponents91;
				float3 weightedAvg5676 = ( ( weightedBlendVar5676.x*( appendResult21_g809 * appendResult5874 ) + weightedBlendVar5676.y*temp_output_6001_0 + weightedBlendVar5676.z*( appendResult20_g813 * appendResult5876 ) )/( weightedBlendVar5676.x + weightedBlendVar5676.y + weightedBlendVar5676.z ) );
				...
				float2 appendResult11_g1004 = (float2(texArray3350.w , texArray3350.y));
				float2 temp_output_4_0_g1004 = ( ( ( appendResult11_g1004 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
				...
				float3 appendResult20_g1004 = (float3(break8_g1004.x , break8_g1004.y , temp_output_9_0_g1004));
				float3 temp_output_6005_0 = appendResult20_g1004;
				...
				float2 appendResult11_g812 = (float2(texArray3384.w , texArray3384.y));
				float2 temp_output_4_0_g812 = ( ( ( appendResult11_g812 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1.0 ) );
				float2 break8_g812 = temp_output_4_0_g812;
				float dotResult5_g812 = dot( temp_output_4_0_g812 , temp_output_4_0_g812 );
				float temp_output_9_0_g812 = sqrt( ( 1.0 - saturate( dotResult5_g812 ) ) );
				float3 appendResult21_g812 = (float3(break8_g812.y , break8_g812.x , temp_output_9_0_g812));
				...
				float2 appendResult11_g806 = (float2(texArray3351.w , texArray3351.y));
				float2 temp_output_4_0_g806 = ( ( ( appendResult11_g806 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
				...
				float3 appendResult20_g806 = (float3(break8_g806.x , break8_g806.y , temp_output_9_0_g806));
				float3 appendResult5882 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5499 = BlendComponents91;
				float3 weightedAvg5499 = ( ( weightedBlendVar5499.x*( appendResult21_g812 * appendResult5879 ) + weightedBlendVar5499.y*temp_output_6005_0 + weightedBlendVar5499.z*( appendResult20_g806 * appendResult5882 ) )/( weightedBlendVar5499.x + weightedBlendVar5499.y + weightedBlendVar5499.z ) );
				...
				float2 appendResult11_g1009 = (float2(texArray3416.w , texArray3416.y));
				float2 temp_output_4_0_g1009 = ( ( ( appendResult11_g1009 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
				...
				float3 appendResult20_g1009 = (float3(break8_g1009.x , break8_g1009.y , temp_output_9_0_g1009));
				float3 temp_output_6008_0 = appendResult20_g1009;
				...
				float2 appendResult11_g808 = (float2(texArray3445.w , texArray3445.y));
				float2 temp_output_4_0_g808 = ( ( ( appendResult11_g808 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g808 = (float3(break8_g808.y , break8_g808.x , temp_output_9_0_g808));
				...
				float2 appendResult11_g811 = (float2(texArray3417.w , texArray3417.y));
				float2 temp_output_4_0_g811 = ( ( ( appendResult11_g811 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
				float2 break8_g811 = temp_output_4_0_g811;
				float dotResult5_g811 = dot( temp_output_4_0_g811 , temp_output_4_0_g811 );
				float temp_output_9_0_g811 = sqrt( ( 1.0 - saturate( dotResult5_g811 ) ) );
				float3 appendResult20_g811 = (float3(break8_g811.x , break8_g811.y , temp_output_9_0_g811));
				float3 appendResult5889 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5503 = BlendComponents91;
				float3 weightedAvg5503 = ( ( weightedBlendVar5503.x*( appendResult21_g808 * appendResult5886 ) + weightedBlendVar5503.y*temp_output_6008_0 + weightedBlendVar5503.z*( appendResult20_g811 * appendResult5889 ) )/( weightedBlendVar5503.x + weightedBlendVar5503.y + weightedBlendVar5503.z ) );
				...
				float2 appendResult11_g1002 = (float2(texArray3483.w , texArray3483.y));
				float2 temp_output_4_0_g1002 = ( ( ( appendResult11_g1002 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
				float2 break8_g1002 = temp_output_4_0_g1002;
				...
				float3 appendResult20_g1002 = (float3(break8_g1002.x , break8_g1002.y , temp_output_9_0_g1002));
				float3 temp_output_6011_0 = appendResult20_g1002;
				...
				float2 appendResult11_g807 = (float2(texArray3512.w , texArray3512.y));
				float2 temp_output_4_0_g807 = ( ( ( appendResult11_g807 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g807 = (float3(break8_g807.y , break8_g807.x , temp_output_9_0_g807));
				...
				float2 appendResult11_g810 = (float2(texArray3484.w , texArray3484.y));
				float2 temp_output_4_0_g810 = ( ( ( appendResult11_g810 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
				float2 break8_g810 = temp_output_4_0_g810;
				float dotResult5_g810 = dot( temp_output_4_0_g810 , temp_output_4_0_g810 );
				float temp_output_9_0_g810 = sqrt( ( 1.0 - saturate( dotResult5_g810 ) ) );
				float3 appendResult20_g810 = (float3(break8_g810.x , break8_g810.y , temp_output_9_0_g810));
				float3 appendResult5896 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5507 = BlendComponents91;
				float3 weightedAvg5507 = ( ( weightedBlendVar5507.x*( appendResult21_g807 * appendResult5893 ) + weightedBlendVar5507.y*temp_output_6011_0 + weightedBlendVar5507.z*( appendResult20_g810 * appendResult5896 ) )/( weightedBlendVar5507.x + weightedBlendVar5507.y + weightedBlendVar5507.z ) );
				...
				float2 appendResult11_g1018 = (float2(texArray4424.w , texArray4424.y));
				float2 temp_output_4_0_g1018 = ( ( ( appendResult11_g1018 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
				...
				float3 appendResult20_g1018 = (float3(break8_g1018.x , break8_g1018.y , temp_output_9_0_g1018));
				float3 temp_output_6014_0 = appendResult20_g1018;
				...
				float2 appendResult11_g1010 = (float2(texArray4417.w , texArray4417.y));
				float2 temp_output_4_0_g1010 = ( ( ( appendResult11_g1010 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g1010 = (float3(break8_g1010.y , break8_g1010.x , temp_output_9_0_g1010));
				...
				float2 appendResult11_g1001 = (float2(texArray4422.w , texArray4422.y));
				float2 temp_output_4_0_g1001 = ( ( ( appendResult11_g1001 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
				float2 break8_g1001 = temp_output_4_0_g1001;
				...
				float3 appendResult20_g1001 = (float3(break8_g1001.x , break8_g1001.y , temp_output_9_0_g1001));
				float3 appendResult5903 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5511 = BlendComponents91;
				float3 weightedAvg5511 = ( ( weightedBlendVar5511.x*( appendResult21_g1010 * appendResult5900 ) + weightedBlendVar5511.y*temp_output_6014_0 + weightedBlendVar5511.z*( appendResult20_g1001 * appendResult5903 ) )/( weightedBlendVar5511.x + weightedBlendVar5511.y + weightedBlendVar5511.z ) );
				...
				float2 appendResult11_g1019 = (float2(texArray4493.w , texArray4493.y));
				float2 temp_output_4_0_g1019 = ( ( ( appendResult11_g1019 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
				...
				float3 appendResult20_g1019 = (float3(break8_g1019.x , break8_g1019.y , temp_output_9_0_g1019));
				float3 temp_output_6017_0 = appendResult20_g1019;
				...
				float2 appendResult11_g1006 = (float2(texArray4486.w , texArray4486.y));
				float2 temp_output_4_0_g1006 = ( ( ( appendResult11_g1006 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g1006 = (float3(break8_g1006.y , break8_g1006.x , temp_output_9_0_g1006));
				...
				float2 appendResult11_g999 = (float2(texArray4491.w , texArray4491.y));
				float2 temp_output_4_0_g999 = ( ( ( appendResult11_g999 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
				...
				float3 appendResult20_g999 = (float3(break8_g999.x , break8_g999.y , temp_output_9_0_g999));
				float3 appendResult5910 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5519 = BlendComponents91;
				float3 weightedAvg5519 = ( ( weightedBlendVar5519.x*( appendResult21_g1006 * appendResult5907 ) + weightedBlendVar5519.y*temp_output_6017_0 + weightedBlendVar5519.z*( appendResult20_g999 * appendResult5910 ) )/( weightedBlendVar5519.x + weightedBlendVar5519.y + weightedBlendVar5519.z ) );
				...
				float2 appendResult11_g1022 = (float2(texArray4567.w , texArray4567.y));
				float2 temp_output_4_0_g1022 = ( ( ( appendResult11_g1022 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
				...
				float3 temp_output_6020_0 = appendResult20_g1022;
				...
				float2 appendResult11_g1005 = (float2(texArray4560.w , texArray4560.y));
				float2 temp_output_4_0_g1005 = ( ( ( appendResult11_g1005 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g1005 = (float3(break8_g1005.y , break8_g1005.x , temp_output_9_0_g1005));
				...
				float2 appendResult11_g1008 = (float2(texArray4565.w , texArray4565.y));
				float2 temp_output_4_0_g1008 = ( ( ( appendResult11_g1008 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
				...
				float3 appendResult20_g1008 = (float3(break8_g1008.x , break8_g1008.y , temp_output_9_0_g1008));
				float3 appendResult5917 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5523 = BlendComponents91;
				float3 weightedAvg5523 = ( ( weightedBlendVar5523.x*( appendResult21_g1005 * appendResult5914 ) + weightedBlendVar5523.y*temp_output_6020_0 + weightedBlendVar5523.z*( appendResult20_g1008 * appendResult5917 ) )/( weightedBlendVar5523.x + weightedBlendVar5523.y + weightedBlendVar5523.z ) );
				...
				float2 appendResult11_g1014 = (float2(texArray4641.w , texArray4641.y));
				float2 temp_output_4_0_g1014 = ( ( ( appendResult11_g1014 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
				...
				float3 appendResult20_g1014 = (float3(break8_g1014.x , break8_g1014.y , temp_output_9_0_g1014));
				float3 temp_output_6023_0 = appendResult20_g1014;
				...
				float2 appendResult11_g1007 = (float2(texArray4634.w , texArray4634.y));
				float2 temp_output_4_0_g1007 = ( ( ( appendResult11_g1007 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g1007 = (float3(break8_g1007.y , break8_g1007.x , temp_output_9_0_g1007));
				...
				float2 appendResult11_g1000 = (float2(texArray4639.w , texArray4639.y));
				float2 temp_output_4_0_g1000 = ( ( ( appendResult11_g1000 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
				...
				float3 appendResult20_g1000 = (float3(break8_g1000.x , break8_g1000.y , temp_output_9_0_g1000));
				float3 appendResult5924 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5527 = BlendComponents91;
				float3 weightedAvg5527 = ( ( weightedBlendVar5527.x*( appendResult21_g1007 * appendResult5921 ) + weightedBlendVar5527.y*temp_output_6023_0 + weightedBlendVar5527.z*( appendResult20_g1000 * appendResult5924 ) )/( weightedBlendVar5527.x + weightedBlendVar5527.y + weightedBlendVar5527.z ) );
				...
				float2 appendResult11_g1028 = (float2(texArray4788.w , texArray4788.y));
				float2 temp_output_4_0_g1028 = ( ( ( appendResult11_g1028 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
				...
				float3 temp_output_6047_0 = appendResult20_g1028;
				...
				float2 appendResult11_g1013 = (float2(texArray5285.w , texArray5285.y));
				float2 temp_output_4_0_g1013 = ( ( ( appendResult11_g1013 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g1013 = (float3(break8_g1013.y , break8_g1013.x , temp_output_9_0_g1013));
				...
				float2 appendResult11_g1012 = (float2(texArray4783.w , texArray4783.y));
				float2 temp_output_4_0_g1012 = ( ( ( appendResult11_g1012 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
				...
				float3 appendResult20_g1012 = (float3(break8_g1012.x , break8_g1012.y , temp_output_9_0_g1012));
				float3 appendResult5980 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5491 = BlendComponents91;
				float3 weightedAvg5491 = ( ( weightedBlendVar5491.x*( appendResult21_g1013 * appendResult5977 ) + weightedBlendVar5491.y*temp_output_6047_0 + weightedBlendVar5491.z*( appendResult20_g1012 * appendResult5980 ) )/( weightedBlendVar5491.x + weightedBlendVar5491.y + weightedBlendVar5491.z ) );
				...
				float2 appendResult11_g1034 = (float2(texArray4822.w , texArray4822.y));
				float2 temp_output_4_0_g1034 = ( ( ( appendResult11_g1034 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
				...
				float3 appendResult20_g1034 = (float3(break8_g1034.x , break8_g1034.y , temp_output_9_0_g1034));
				float3 temp_output_6044_0 = appendResult20_g1034;
				...
				float2 appendResult11_g1011 = (float2(texArray4798.w , texArray4798.y));
				float2 temp_output_4_0_g1011 = ( ( ( appendResult11_g1011 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g1011 = (float3(break8_g1011.y , break8_g1011.x , temp_output_9_0_g1011));
				...
				float2 appendResult11_g1020 = (float2(texArray4791.w , texArray4791.y));
				float2 temp_output_4_0_g1020 = ( ( ( appendResult11_g1020 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
				...
				float3 appendResult20_g1020 = (float3(break8_g1020.x , break8_g1020.y , temp_output_9_0_g1020));
				float3 appendResult5973 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5531 = BlendComponents91;
				float3 weightedAvg5531 = ( ( weightedBlendVar5531.x*( appendResult21_g1011 * appendResult5970 ) + weightedBlendVar5531.y*temp_output_6044_0 + weightedBlendVar5531.z*( appendResult20_g1020 * appendResult5973 ) )/( weightedBlendVar5531.x + weightedBlendVar5531.y + weightedBlendVar5531.z ) );
				...
				float2 appendResult11_g1037 = (float2(texArray4856.w , texArray4856.y));
				float2 temp_output_4_0_g1037 = ( ( ( appendResult11_g1037 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
				...
				float3 appendResult20_g1037 = (float3(break8_g1037.x , break8_g1037.y , temp_output_9_0_g1037));
				float3 temp_output_6041_0 = appendResult20_g1037;
				...
				float2 appendResult11_g1021 = (float2(texArray4828.w , texArray4828.y));
				float2 temp_output_4_0_g1021 = ( ( ( appendResult11_g1021 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1.0 ) );
				...
				float2 appendResult11_g1017 = (float2(texArray4811.w , texArray4811.y));
				float2 temp_output_4_0_g1017 = ( ( ( appendResult11_g1017 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
				...
				float3 appendResult20_g1017 = (float3(break8_g1017.x , break8_g1017.y , temp_output_9_0_g1017));
				float3 appendResult5966 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5535 = BlendComponents91;
				float3 weightedAvg5535 = ( ( weightedBlendVar5535.x*( appendResult21_g1021 * appendResult5963 ) + weightedBlendVar5535.y*temp_output_6041_0 + weightedBlendVar5535.z*( appendResult20_g1017 * appendResult5966 ) )/( weightedBlendVar5535.x + weightedBlendVar5535.y + weightedBlendVar5535.z ) );
				...
				float2 appendResult11_g1030 = (float2(texArray4870.w , texArray4870.y));
				float2 temp_output_4_0_g1030 = ( ( ( appendResult11_g1030 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
				...
				float3 appendResult20_g1030 = (float3(break8_g1030.x , break8_g1030.y , temp_output_9_0_g1030));
				float3 temp_output_6038_0 = appendResult20_g1030;
				...
				float2 appendResult11_g1016 = (float2(texArray4850.w , texArray4850.y));
				float2 temp_output_4_0_g1016 = ( ( ( appendResult11_g1016 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g1016 = (float3(break8_g1016.y , break8_g1016.x , temp_output_9_0_g1016));
				...
				float2 appendResult11_g1015 = (float2(texArray4852.w , texArray4852.y));
				float2 temp_output_4_0_g1015 = ( ( ( appendResult11_g1015 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
				float2 break8_g1015 = temp_output_4_0_g1015;
				...
				float3 appendResult20_g1015 = (float3(break8_g1015.x , break8_g1015.y , temp_output_9_0_g1015));
				float3 appendResult5959 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5539 = BlendComponents91;
				float3 weightedAvg5539 = ( ( weightedBlendVar5539.x*( appendResult21_g1016 * appendResult5956 ) + weightedBlendVar5539.y*temp_output_6038_0 + weightedBlendVar5539.z*( appendResult20_g1015 * appendResult5959 ) )/( weightedBlendVar5539.x + weightedBlendVar5539.y + weightedBlendVar5539.z ) );
				...
				float2 appendResult11_g1039 = (float2(texArray5120.w , texArray5120.y));
				...
				float3 appendResult20_g1039 = (float3(break8_g1039.x , break8_g1039.y , temp_output_9_0_g1039));
				float3 temp_output_6035_0 = appendResult20_g1039;
				...
				float2 appendResult11_g1033 = (float2(texArray5127.w , texArray5127.y));
				float2 temp_output_4_0_g1033 = ( ( ( appendResult11_g1033 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g1033 = (float3(break8_g1033.y , break8_g1033.x , temp_output_9_0_g1033));
				...
				float2 appendResult11_g1029 = (float2(texArray5109.w , texArray5109.y));
				float2 temp_output_4_0_g1029 = ( ( ( appendResult11_g1029 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
				...
				float3 weightedAvg5543 = ( ( weightedBlendVar5543.x*( appendResult21_g1033 * appendResult5949 ) + weightedBlendVar5543.y*temp_output_6035_0 + weightedBlendVar5543.z*( appendResult20_g1029 * appendResult5952 ) )/( weightedBlendVar5543.x + weightedBlendVar5543.y + weightedBlendVar5543.z ) );
				...
				float2 appendResult11_g1038 = (float2(texArray5178.w , texArray5178.y));
				float2 temp_output_4_0_g1038 = ( ( ( appendResult11_g1038 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
				...
				float3 appendResult20_g1038 = (float3(break8_g1038.x , break8_g1038.y , temp_output_9_0_g1038));
				float3 temp_output_6032_0 = appendResult20_g1038;
				...
				float2 appendResult11_g1031 = (float2(texArray5017.w , texArray5017.y));
				float2 temp_output_4_0_g1031 = ( ( ( appendResult11_g1031 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1.0 ) );
				...
				float2 appendResult11_g1026 = (float2(texArray5170.w , texArray5170.y));
				float2 temp_output_4_0_g1026 = ( ( ( appendResult11_g1026 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
				...
				float3 weightedAvg5547 = ( ( weightedBlendVar5547.x*( appendResult21_g1031 * appendResult5942 ) + weightedBlendVar5547.y*temp_output_6032_0 + weightedBlendVar5547.z*( appendResult20_g1026 * appendResult5945 ) )/( weightedBlendVar5547.x + weightedBlendVar5547.y + weightedBlendVar5547.z ) );
				...
				float2 appendResult11_g1041 = (float2(texArray5246.w , texArray5246.y));
				...
				float3 appendResult20_g1041 = (float3(break8_g1041.x , break8_g1041.y , temp_output_9_0_g1041));
				float3 temp_output_6029_0 = appendResult20_g1041;
				...
				float2 appendResult11_g1027 = (float2(texArray5227.w , texArray5227.y));
				float2 temp_output_4_0_g1027 = ( ( ( appendResult11_g1027 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1.0 ) );
				...
				float2 appendResult11_g1032 = (float2(texArray5250.w , texArray5250.y));
				float2 temp_output_4_0_g1032 = ( ( ( appendResult11_g1032 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
				...
				float3 weightedAvg5551 = ( ( weightedBlendVar5551.x*( appendResult21_g1027 * appendResult5935 ) + weightedBlendVar5551.y*temp_output_6029_0 + weightedBlendVar5551.z*( appendResult20_g1032 * appendResult5938 ) )/( weightedBlendVar5551.x + weightedBlendVar5551.y + weightedBlendVar5551.z ) );
				...
				float2 appendResult11_g1040 = (float2(texArray5099.w , texArray5099.y));
				float2 temp_output_4_0_g1040 = ( ( ( appendResult11_g1040 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
				...
				float3 appendResult20_g1040 = (float3(break8_g1040.x , break8_g1040.y , temp_output_9_0_g1040));
				float3 temp_output_6026_0 = appendResult20_g1040;
				...
				float2 appendResult11_g1035 = (float2(texArray5082.w , texArray5082.y));
				float2 temp_output_4_0_g1035 = ( ( ( appendResult11_g1035 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1.0 ) );
				...
				float3 appendResult21_g1035 = (float3(break8_g1035.y , break8_g1035.x , temp_output_9_0_g1035));
				...
				float2 appendResult11_g1036 = (float2(texArray4731.w , texArray4731.y));
				float2 temp_output_4_0_g1036 = ( ( ( appendResult11_g1036 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
				...
				float3 appendResult20_g1036 = (float3(break8_g1036.x , break8_g1036.y , temp_output_9_0_g1036));
				float3 appendResult5931 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar5555 = BlendComponents91;
				float3 weightedAvg5555 = ( ( weightedBlendVar5555.x*( appendResult21_g1035 * appendResult5928 ) + weightedBlendVar5555.y*temp_output_6026_0 + weightedBlendVar5555.z*( appendResult20_g1036 * appendResult5931 ) )/( weightedBlendVar5555.x + weightedBlendVar5555.y + weightedBlendVar5555.z ) );
				...
				float2 appendResult11_g1042 = (float2(texArray4382.w , texArray4382.y));
				float2 temp_output_4_0_g1042 = ( ( ( appendResult11_g1042 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
				...
				float3 appendResult20_g1042 = (float3(break8_g1042.x , break8_g1042.y , temp_output_9_0_g1042));
				float3 ifLocalVar6166 = 0;
				UNITY_BRANCH 
				if( _Texture_Snow_Normal_Index <= -1.0 )
				ifLocalVar6166 = EmptyNRM6172;
				else
				ifLocalVar6166 = appendResult20_g1042;
				float simplePerlin2D6330 = snoise( ( Top_Bottom1999 * _Snow_Noise_Tiling ) );
				float clampResult6335 = clamp( simplePerlin2D6330 , 0.0 , 1.0 );
				float lerpResult4310 = lerp( 1.0 , clampResult6335 , _Snow_Noise_Power);
				...
				float2 appendResult11_g1043 = (float2(texArray5480.w , texArray5480.y));
				float2 temp_output_4_0_g1043 = ( ( ( appendResult11_g1043 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
				...
				float3 appendResult20_g1043 = (float3(break8_g1043.x , break8_g1043.y , temp_output_9_0_g1043));
				...
				float2 appendResult11_g1044 = (float2(texArray4374.w , texArray4374.y));
				float2 temp_output_4_0_g1044 = ( ( ( appendResult11_g1044 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
				...
				float3 appendResult20_g1044 = (float3(break8_g1044.x , break8_g1044.y , temp_output_9_0_g1044));
				float3 lerpResult5460 = lerp( appendResult20_g1043 , appendResult20_g1044 , UVmixDistance636);
				...
				float clampResult6306 = clamp( temp_output_6305_0 , 0.0 , 1.0 );
				...
				float lerpResult6307 = lerp( break1409.w , _Glitter_Smoothness , clampResult6306);
				float lerpResult3951 = lerp( ( break3856.w * _Terrain_Smoothness ) , lerpResult6307 , lerpResult3742);
