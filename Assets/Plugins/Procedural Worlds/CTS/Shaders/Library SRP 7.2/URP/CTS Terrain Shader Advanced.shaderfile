Shader "CTS/URP/CTS Terrain Shader Advanced"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v  )
        	{
				...
				float3 localCalculateTangentsSRP8136 = ( ( v.ase_tangent.xyz * 0.0 ) );
				...
				float3 vertexValue = localCalculateTangentsSRP8136;
    ...
    o.shadowCoord = GetShadowCoord(vertexInput);
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float clampResult297 = clamp( pow( abs( ( max( max( break7977.x , break7977.y ) , break7977.z ) / _UV_Mix_Start_Distance ) ) , _UV_Mix_Power ) , 0.0 , 1.0 );
				...
				float2 appendResult7986 = (float2(1.0 , ( lerpResult7983 * clampResult8078 )));
				float3 break8106 = WorldSpacePosition;
				float2 appendResult8002 = (float2(break8106.x , break8106.z));
				...
				float3 clampResult6387 = clamp( pow( abs( ( WorldSpaceNormal * WorldSpaceNormal ) ) , 25.0 ) , float3( -1,-1,-1 ) , float3( 1,1,1 ) );
				half3 BlendComponents91 = clampResult6387;
				float2 appendResult8003 = (float2(break8106.z , break8106.y));
				...
				float2 appendResult8001 = (float2(break8106.x , break8106.y));
				...
				float temp_output_6168_0 = ( _Texture_13_Heightmap_Depth * pow( abs( break7920.x ) , _Texture_13_Height_Contrast ) );
				...
				float temp_output_6174_0 = ( _Texture_14_Heightmap_Depth * pow( abs( break7921.x ) , _Texture_14_Height_Contrast ) );
				...
				float HeightMask6237 = saturate(pow(((( _Texture_15_Heightmap_Depth * pow( abs( break7922.x ) , _Texture_15_Height_Contrast ) )*Splat4_B2545)*4)+(Splat4_B2545*2),lerpResult7265));
				...
				float HeightMask6240 = saturate(pow(((( _Texture_16_Heightmap_Depth * pow( abs( break7923.x ) , _Texture_16_Height_Contrast ) )*Splat4_A2546)*4)+(Splat4_A2546*2),lerpResult7269));
				...
				float temp_output_6144_0 = ( _Texture_9_Heightmap_Depth * pow( abs( break7915.x ) , _Texture_9_Height_Contrast ) );
				...
				float temp_output_6150_0 = ( _Texture_10_Heightmap_Depth * pow( abs( break7916.x ) , _Texture_10_Height_Contrast ) );
				...
				float temp_output_6156_0 = ( _Texture_11_Heightmap_Depth * pow( abs( break7917.x ) , _Texture_11_Height_Contrast ) );
				...
				float HeightMask6228 = saturate(pow(((( _Texture_12_Heightmap_Depth * pow( abs( break7918.x ) , _Texture_12_Height_Contrast ) )*Splat3_A2540)*4)+(Splat3_A2540*2),lerpResult7254));
				...
				float temp_output_6120_0 = ( _Texture_5_Heightmap_Depth * pow( abs( break7910.x ) , _Texture_5_Height_Contrast ) );
				...
				float temp_output_6126_0 = ( _Texture_6_Heightmap_Depth * pow( abs( break7911.x ) , _Texture_6_Height_Contrast ) );
				...
				float temp_output_6132_0 = ( _Texture_7_Heightmap_Depth * pow( abs( break7912.x ) , _Texture_7_Height_Contrast ) );
				...
				float temp_output_6138_0 = ( _Texture_8_Heightmap_Depth * pow( abs( break7913.x ) , _Texture_8_Height_Contrast ) );
				...
				float temp_output_5544_0 = ( pow( abs( break7905.x ) , _Texture_1_Height_Contrast ) * _Texture_1_Heightmap_Depth );
				...
				float temp_output_5545_0 = ( _Texture_2_Heightmap_Depth * pow( abs( break7906.x ) , _Texture_2_Height_Contrast ) );
				...
				float temp_output_5590_0 = ( _Texture_3_Heightmap_Depth * pow( abs( break7907.x ) , _Texture_3_Height_Contrast ) );
				...
				float temp_output_6118_0 = ( _Texture_4_Heightmap_Depth * pow( abs( break7908.x ) , _Texture_4_Height_Contrast ) );
				...
				float3 appendResult7996 = (float3(tex2DNode7984.rgb));
				...
				float4 tex2DNode6968 = tex2D( _Texture_Geological_Map, temp_cast_2 );
				...
				float4 tex2DNode6969 = tex2D( _Texture_Geological_Map, temp_cast_3 );
				...
				float2 appendResult8073 = (float2(break8074.y , break8074.x));
				float4 tex2DNode8041 = tex2D( _Texture_Glitter, ( appendResult8073 + float2( 0.37,0.67 ) ) );
				...
				float clampResult8045 = clamp( pow( abs( tex2D( _Texture_Glitter, ( ( rotator8031 + temp_output_8062_0 ) * float2( 0.2,0.2 ) ) ).r ) , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0.0 , 1.0 );
				...
				float clampResult8051 = clamp( pow( abs( lerpResult8048 ) , 100.0 ) , 0.0 , 1.0 );
				...
				ifLocalVar7801 = ( pow( abs( lerpResult7273 ) , _Snow_Height_Contrast ) * _Snow_Heightmap_Depth );
				...
				float clampResult4146 = clamp( pow( abs( ( ( _Snow_Amount * ( 0.1 - ( _Snow_Maximum_Angle_Hardness * 0.005 ) ) ) * SnowSlope1352 ) ) , clampResult6569 ) , 0.0 , 1.0 );
				...
				float2 appendResult11_g1647 = (float2(texArray6256.w , texArray6256.y));
				float2 temp_output_4_0_g1647 = ( ( ( appendResult11_g1647 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
				float2 break8_g1647 = temp_output_4_0_g1647;
				float dotResult5_g1647 = dot( temp_output_4_0_g1647 , temp_output_4_0_g1647 );
				float temp_output_9_0_g1647 = sqrt( ( 1.0 - saturate( dotResult5_g1647 ) ) );
				float3 appendResult20_g1647 = (float3(break8_g1647.x , break8_g1647.y , temp_output_9_0_g1647));
				...
				float2 appendResult11_g1648 = (float2(texArray4374.w , texArray4374.y));
				float2 temp_output_4_0_g1648 = ( ( ( appendResult11_g1648 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
				float2 break8_g1648 = temp_output_4_0_g1648;
				float dotResult5_g1648 = dot( temp_output_4_0_g1648 , temp_output_4_0_g1648 );
				float temp_output_9_0_g1648 = sqrt( ( 1.0 - saturate( dotResult5_g1648 ) ) );
				float3 appendResult20_g1648 = (float3(break8_g1648.x , break8_g1648.y , temp_output_9_0_g1648));
				float3 lerpResult6257 = lerp( appendResult20_g1647 , appendResult20_g1648 , UVmixDistance636);
				...
				float2 appendResult11_g1676 = (float2(texArray3300.w , texArray3300.y));
				float2 temp_output_4_0_g1676 = ( ( ( appendResult11_g1676 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
				float2 break8_g1676 = temp_output_4_0_g1676;
				float dotResult5_g1676 = dot( temp_output_4_0_g1676 , temp_output_4_0_g1676 );
				float temp_output_9_0_g1676 = sqrt( ( 1.0 - saturate( dotResult5_g1676 ) ) );
				float3 appendResult20_g1676 = (float3(break8_g1676.x , break8_g1676.y , temp_output_9_0_g1676));
				float3 temp_output_6989_0 = appendResult20_g1676;
				...
				float2 appendResult11_g1682 = (float2(texArray3299.w , texArray3299.y));
				float2 temp_output_4_0_g1682 = ( ( ( appendResult11_g1682 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1.0 ) );
				float2 break8_g1682 = temp_output_4_0_g1682;
				float dotResult5_g1682 = dot( temp_output_4_0_g1682 , temp_output_4_0_g1682 );
				float temp_output_9_0_g1682 = sqrt( ( 1.0 - saturate( dotResult5_g1682 ) ) );
				float3 appendResult21_g1682 = (float3(break8_g1682.y , break8_g1682.x , temp_output_9_0_g1682));
				...
				float2 appendResult11_g1675 = (float2(texArray3301.w , texArray3301.y));
				float2 temp_output_4_0_g1675 = ( ( ( appendResult11_g1675 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
				float2 break8_g1675 = temp_output_4_0_g1675;
				float dotResult5_g1675 = dot( temp_output_4_0_g1675 , temp_output_4_0_g1675 );
				float temp_output_9_0_g1675 = sqrt( ( 1.0 - saturate( dotResult5_g1675 ) ) );
				float3 appendResult20_g1675 = (float3(break8_g1675.x , break8_g1675.y , temp_output_9_0_g1675));
				float3 appendResult6860 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6393 = BlendComponents91;
				float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult21_g1682 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult20_g1675 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
				...
				float2 appendResult11_g1686 = (float2(texArray3350.w , texArray3350.y));
				float2 temp_output_4_0_g1686 = ( ( ( appendResult11_g1686 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
				float2 break8_g1686 = temp_output_4_0_g1686;
				float dotResult5_g1686 = dot( temp_output_4_0_g1686 , temp_output_4_0_g1686 );
				float temp_output_9_0_g1686 = sqrt( ( 1.0 - saturate( dotResult5_g1686 ) ) );
				float3 appendResult20_g1686 = (float3(break8_g1686.x , break8_g1686.y , temp_output_9_0_g1686));
				float3 temp_output_6992_0 = appendResult20_g1686;
				...
				float2 appendResult11_g1681 = (float2(texArray3384.w , texArray3384.y));
				float2 temp_output_4_0_g1681 = ( ( ( appendResult11_g1681 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1.0 ) );
				float2 break8_g1681 = temp_output_4_0_g1681;
				float dotResult5_g1681 = dot( temp_output_4_0_g1681 , temp_output_4_0_g1681 );
				float temp_output_9_0_g1681 = sqrt( ( 1.0 - saturate( dotResult5_g1681 ) ) );
				float3 appendResult21_g1681 = (float3(break8_g1681.y , break8_g1681.x , temp_output_9_0_g1681));
				...
				float2 appendResult11_g1692 = (float2(texArray3351.w , texArray3351.y));
				float2 temp_output_4_0_g1692 = ( ( ( appendResult11_g1692 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
				float2 break8_g1692 = temp_output_4_0_g1692;
				float dotResult5_g1692 = dot( temp_output_4_0_g1692 , temp_output_4_0_g1692 );
				float temp_output_9_0_g1692 = sqrt( ( 1.0 - saturate( dotResult5_g1692 ) ) );
				float3 appendResult20_g1692 = (float3(break8_g1692.x , break8_g1692.y , temp_output_9_0_g1692));
				float3 appendResult6867 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6401 = BlendComponents91;
				float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult21_g1681 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult20_g1692 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
				...
				float2 appendResult11_g1673 = (float2(texArray3416.w , texArray3416.y));
				float2 temp_output_4_0_g1673 = ( ( ( appendResult11_g1673 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
				float2 break8_g1673 = temp_output_4_0_g1673;
				float dotResult5_g1673 = dot( temp_output_4_0_g1673 , temp_output_4_0_g1673 );
				float temp_output_9_0_g1673 = sqrt( ( 1.0 - saturate( dotResult5_g1673 ) ) );
				float3 appendResult20_g1673 = (float3(break8_g1673.x , break8_g1673.y , temp_output_9_0_g1673));
				float3 temp_output_6995_0 = appendResult20_g1673;
				...
				float2 appendResult11_g1651 = (float2(texArray3445.w , texArray3445.y));
				float2 temp_output_4_0_g1651 = ( ( ( appendResult11_g1651 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1.0 ) );
				float2 break8_g1651 = temp_output_4_0_g1651;
				float dotResult5_g1651 = dot( temp_output_4_0_g1651 , temp_output_4_0_g1651 );
				float temp_output_9_0_g1651 = sqrt( ( 1.0 - saturate( dotResult5_g1651 ) ) );
				float3 appendResult21_g1651 = (float3(break8_g1651.y , break8_g1651.x , temp_output_9_0_g1651));
				...
				float2 appendResult11_g1665 = (float2(texArray3417.w , texArray3417.y));
				float2 temp_output_4_0_g1665 = ( ( ( appendResult11_g1665 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
				float2 break8_g1665 = temp_output_4_0_g1665;
				float dotResult5_g1665 = dot( temp_output_4_0_g1665 , temp_output_4_0_g1665 );
				float temp_output_9_0_g1665 = sqrt( ( 1.0 - saturate( dotResult5_g1665 ) ) );
				float3 appendResult20_g1665 = (float3(break8_g1665.x , break8_g1665.y , temp_output_9_0_g1665));
				float3 appendResult6874 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6408 = BlendComponents91;
				float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult21_g1651 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult20_g1665 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
				...
				float2 appendResult11_g1685 = (float2(texArray3483.w , texArray3483.y));
				float2 temp_output_4_0_g1685 = ( ( ( appendResult11_g1685 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
				float2 break8_g1685 = temp_output_4_0_g1685;
				float dotResult5_g1685 = dot( temp_output_4_0_g1685 , temp_output_4_0_g1685 );
				float temp_output_9_0_g1685 = sqrt( ( 1.0 - saturate( dotResult5_g1685 ) ) );
				float3 appendResult20_g1685 = (float3(break8_g1685.x , break8_g1685.y , temp_output_9_0_g1685));
				float3 temp_output_6998_0 = appendResult20_g1685;
				...
				float2 appendResult11_g1672 = (float2(texArray3512.w , texArray3512.y));
				float2 temp_output_4_0_g1672 = ( ( ( appendResult11_g1672 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1.0 ) );
				float2 break8_g1672 = temp_output_4_0_g1672;
				float dotResult5_g1672 = dot( temp_output_4_0_g1672 , temp_output_4_0_g1672 );
				float temp_output_9_0_g1672 = sqrt( ( 1.0 - saturate( dotResult5_g1672 ) ) );
				float3 appendResult21_g1672 = (float3(break8_g1672.y , break8_g1672.x , temp_output_9_0_g1672));
				...
				float2 appendResult11_g1683 = (float2(texArray3484.w , texArray3484.y));
				float2 temp_output_4_0_g1683 = ( ( ( appendResult11_g1683 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
				float2 break8_g1683 = temp_output_4_0_g1683;
				float dotResult5_g1683 = dot( temp_output_4_0_g1683 , temp_output_4_0_g1683 );
				float temp_output_9_0_g1683 = sqrt( ( 1.0 - saturate( dotResult5_g1683 ) ) );
				float3 appendResult20_g1683 = (float3(break8_g1683.x , break8_g1683.y , temp_output_9_0_g1683));
				float3 appendResult6881 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6415 = BlendComponents91;
				float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult21_g1672 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult20_g1683 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
				...
				float2 appendResult11_g1666 = (float2(texArray4424.w , texArray4424.y));
				float2 temp_output_4_0_g1666 = ( ( ( appendResult11_g1666 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
				float2 break8_g1666 = temp_output_4_0_g1666;
				float dotResult5_g1666 = dot( temp_output_4_0_g1666 , temp_output_4_0_g1666 );
				float temp_output_9_0_g1666 = sqrt( ( 1.0 - saturate( dotResult5_g1666 ) ) );
				float3 appendResult20_g1666 = (float3(break8_g1666.x , break8_g1666.y , temp_output_9_0_g1666));
				float3 temp_output_7001_0 = appendResult20_g1666;
				...
				float2 appendResult11_g1688 = (float2(texArray4417.w , texArray4417.y));
				float2 temp_output_4_0_g1688 = ( ( ( appendResult11_g1688 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1.0 ) );
				float2 break8_g1688 = temp_output_4_0_g1688;
				float dotResult5_g1688 = dot( temp_output_4_0_g1688 , temp_output_4_0_g1688 );
				float temp_output_9_0_g1688 = sqrt( ( 1.0 - saturate( dotResult5_g1688 ) ) );
				float3 appendResult21_g1688 = (float3(break8_g1688.y , break8_g1688.x , temp_output_9_0_g1688));
				...
				float2 appendResult11_g1690 = (float2(texArray4422.w , texArray4422.y));
				float2 temp_output_4_0_g1690 = ( ( ( appendResult11_g1690 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
				float2 break8_g1690 = temp_output_4_0_g1690;
				float dotResult5_g1690 = dot( temp_output_4_0_g1690 , temp_output_4_0_g1690 );
				float temp_output_9_0_g1690 = sqrt( ( 1.0 - saturate( dotResult5_g1690 ) ) );
				float3 appendResult20_g1690 = (float3(break8_g1690.x , break8_g1690.y , temp_output_9_0_g1690));
				float3 appendResult6888 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6422 = BlendComponents91;
				float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult21_g1688 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult20_g1690 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
				...
				float2 appendResult11_g1649 = (float2(texArray4493.w , texArray4493.y));
				float2 temp_output_4_0_g1649 = ( ( ( appendResult11_g1649 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
				float2 break8_g1649 = temp_output_4_0_g1649;
				float dotResult5_g1649 = dot( temp_output_4_0_g1649 , temp_output_4_0_g1649 );
				float temp_output_9_0_g1649 = sqrt( ( 1.0 - saturate( dotResult5_g1649 ) ) );
				float3 appendResult20_g1649 = (float3(break8_g1649.x , break8_g1649.y , temp_output_9_0_g1649));
				float3 temp_output_7004_0 = appendResult20_g1649;
				...
				float2 appendResult11_g1687 = (float2(texArray4486.w , texArray4486.y));
				float2 temp_output_4_0_g1687 = ( ( ( appendResult11_g1687 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1.0 ) );
				float2 break8_g1687 = temp_output_4_0_g1687;
				float dotResult5_g1687 = dot( temp_output_4_0_g1687 , temp_output_4_0_g1687 );
				float temp_output_9_0_g1687 = sqrt( ( 1.0 - saturate( dotResult5_g1687 ) ) );
				float3 appendResult21_g1687 = (float3(break8_g1687.y , break8_g1687.x , temp_output_9_0_g1687));
				...
				float2 appendResult11_g1680 = (float2(texArray4491.w , texArray4491.y));
				float2 temp_output_4_0_g1680 = ( ( ( appendResult11_g1680 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
				float2 break8_g1680 = temp_output_4_0_g1680;
				float dotResult5_g1680 = dot( temp_output_4_0_g1680 , temp_output_4_0_g1680 );
				float temp_output_9_0_g1680 = sqrt( ( 1.0 - saturate( dotResult5_g1680 ) ) );
				float3 appendResult20_g1680 = (float3(break8_g1680.x , break8_g1680.y , temp_output_9_0_g1680));
				float3 appendResult6895 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6429 = BlendComponents91;
				float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult21_g1687 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult20_g1680 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
				...
				float2 appendResult11_g1668 = (float2(texArray4567.w , texArray4567.y));
				float2 temp_output_4_0_g1668 = ( ( ( appendResult11_g1668 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
				float2 break8_g1668 = temp_output_4_0_g1668;
				float dotResult5_g1668 = dot( temp_output_4_0_g1668 , temp_output_4_0_g1668 );
				float temp_output_9_0_g1668 = sqrt( ( 1.0 - saturate( dotResult5_g1668 ) ) );
				float3 appendResult20_g1668 = (float3(break8_g1668.x , break8_g1668.y , temp_output_9_0_g1668));
				float3 temp_output_7007_0 = appendResult20_g1668;
				...
				float2 appendResult11_g1670 = (float2(texArray4560.w , texArray4560.y));
				float2 temp_output_4_0_g1670 = ( ( ( appendResult11_g1670 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1.0 ) );
				float2 break8_g1670 = temp_output_4_0_g1670;
				float dotResult5_g1670 = dot( temp_output_4_0_g1670 , temp_output_4_0_g1670 );
				float temp_output_9_0_g1670 = sqrt( ( 1.0 - saturate( dotResult5_g1670 ) ) );
				float3 appendResult21_g1670 = (float3(break8_g1670.y , break8_g1670.x , temp_output_9_0_g1670));
				...
				float2 appendResult11_g1679 = (float2(texArray4565.w , texArray4565.y));
				float2 temp_output_4_0_g1679 = ( ( ( appendResult11_g1679 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
				float2 break8_g1679 = temp_output_4_0_g1679;
				float dotResult5_g1679 = dot( temp_output_4_0_g1679 , temp_output_4_0_g1679 );
				float temp_output_9_0_g1679 = sqrt( ( 1.0 - saturate( dotResult5_g1679 ) ) );
				float3 appendResult20_g1679 = (float3(break8_g1679.x , break8_g1679.y , temp_output_9_0_g1679));
				float3 appendResult6902 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6436 = BlendComponents91;
				float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult21_g1670 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult20_g1679 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
				...
				float2 appendResult11_g1674 = (float2(texArray4641.w , texArray4641.y));
				float2 temp_output_4_0_g1674 = ( ( ( appendResult11_g1674 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
				float2 break8_g1674 = temp_output_4_0_g1674;
				float dotResult5_g1674 = dot( temp_output_4_0_g1674 , temp_output_4_0_g1674 );
				float temp_output_9_0_g1674 = sqrt( ( 1.0 - saturate( dotResult5_g1674 ) ) );
				float3 appendResult20_g1674 = (float3(break8_g1674.x , break8_g1674.y , temp_output_9_0_g1674));
				float3 temp_output_7010_0 = appendResult20_g1674;
				...
				float2 appendResult11_g1677 = (float2(texArray4634.w , texArray4634.y));
				float2 temp_output_4_0_g1677 = ( ( ( appendResult11_g1677 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1.0 ) );
				float2 break8_g1677 = temp_output_4_0_g1677;
				float dotResult5_g1677 = dot( temp_output_4_0_g1677 , temp_output_4_0_g1677 );
				float temp_output_9_0_g1677 = sqrt( ( 1.0 - saturate( dotResult5_g1677 ) ) );
				float3 appendResult21_g1677 = (float3(break8_g1677.y , break8_g1677.x , temp_output_9_0_g1677));
				...
				float2 appendResult11_g1691 = (float2(texArray4639.w , texArray4639.y));
				float2 temp_output_4_0_g1691 = ( ( ( appendResult11_g1691 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
				float2 break8_g1691 = temp_output_4_0_g1691;
				float dotResult5_g1691 = dot( temp_output_4_0_g1691 , temp_output_4_0_g1691 );
				float temp_output_9_0_g1691 = sqrt( ( 1.0 - saturate( dotResult5_g1691 ) ) );
				float3 appendResult20_g1691 = (float3(break8_g1691.x , break8_g1691.y , temp_output_9_0_g1691));
				float3 appendResult6909 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6443 = BlendComponents91;
				float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult21_g1677 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult20_g1691 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
				...
				float2 appendResult11_g1689 = (float2(texArray4788.w , texArray4788.y));
				float2 temp_output_4_0_g1689 = ( ( ( appendResult11_g1689 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
				float2 break8_g1689 = temp_output_4_0_g1689;
				float dotResult5_g1689 = dot( temp_output_4_0_g1689 , temp_output_4_0_g1689 );
				float temp_output_9_0_g1689 = sqrt( ( 1.0 - saturate( dotResult5_g1689 ) ) );
				float3 appendResult20_g1689 = (float3(break8_g1689.x , break8_g1689.y , temp_output_9_0_g1689));
				float3 temp_output_7034_0 = appendResult20_g1689;
				...
				float2 appendResult11_g1638 = (float2(texArray5285.x , texArray5285.y));
				float2 temp_output_4_0_g1638 = ( ( ( appendResult11_g1638 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1.0 ) );
				float2 break8_g1638 = temp_output_4_0_g1638;
				float dotResult5_g1638 = dot( temp_output_4_0_g1638 , temp_output_4_0_g1638 );
				float temp_output_9_0_g1638 = sqrt( ( 1.0 - saturate( dotResult5_g1638 ) ) );
				float3 appendResult21_g1638 = (float3(break8_g1638.y , break8_g1638.x , temp_output_9_0_g1638));
				...
				float2 appendResult11_g1655 = (float2(texArray4783.w , texArray4783.y));
				float2 temp_output_4_0_g1655 = ( ( ( appendResult11_g1655 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
				float2 break8_g1655 = temp_output_4_0_g1655;
				float dotResult5_g1655 = dot( temp_output_4_0_g1655 , temp_output_4_0_g1655 );
				float temp_output_9_0_g1655 = sqrt( ( 1.0 - saturate( dotResult5_g1655 ) ) );
				float3 appendResult20_g1655 = (float3(break8_g1655.x , break8_g1655.y , temp_output_9_0_g1655));
				float3 appendResult6965 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6450 = BlendComponents91;
				float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult21_g1638 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult20_g1655 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
				...
				float2 appendResult11_g1660 = (float2(texArray4822.w , texArray4822.y));
				float2 temp_output_4_0_g1660 = ( ( ( appendResult11_g1660 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
				float2 break8_g1660 = temp_output_4_0_g1660;
				float dotResult5_g1660 = dot( temp_output_4_0_g1660 , temp_output_4_0_g1660 );
				float temp_output_9_0_g1660 = sqrt( ( 1.0 - saturate( dotResult5_g1660 ) ) );
				float3 appendResult20_g1660 = (float3(break8_g1660.x , break8_g1660.y , temp_output_9_0_g1660));
				float3 temp_output_7031_0 = appendResult20_g1660;
				...
				float2 appendResult11_g1650 = (float2(texArray4798.w , texArray4798.y));
				float2 temp_output_4_0_g1650 = ( ( ( appendResult11_g1650 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1.0 ) );
				float2 break8_g1650 = temp_output_4_0_g1650;
				float dotResult5_g1650 = dot( temp_output_4_0_g1650 , temp_output_4_0_g1650 );
				float temp_output_9_0_g1650 = sqrt( ( 1.0 - saturate( dotResult5_g1650 ) ) );
				float3 appendResult21_g1650 = (float3(break8_g1650.y , break8_g1650.x , temp_output_9_0_g1650));
				...
				float2 appendResult11_g1653 = (float2(texArray4791.w , texArray4791.y));
				float2 temp_output_4_0_g1653 = ( ( ( appendResult11_g1653 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
				float2 break8_g1653 = temp_output_4_0_g1653;
				float dotResult5_g1653 = dot( temp_output_4_0_g1653 , temp_output_4_0_g1653 );
				float temp_output_9_0_g1653 = sqrt( ( 1.0 - saturate( dotResult5_g1653 ) ) );
				float3 appendResult20_g1653 = (float3(break8_g1653.x , break8_g1653.y , temp_output_9_0_g1653));
				float3 appendResult6958 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6457 = BlendComponents91;
				float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult21_g1650 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult20_g1653 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
				...
				float2 appendResult11_g1684 = (float2(texArray4856.w , texArray4856.y));
				float2 temp_output_4_0_g1684 = ( ( ( appendResult11_g1684 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
				float2 break8_g1684 = temp_output_4_0_g1684;
				float dotResult5_g1684 = dot( temp_output_4_0_g1684 , temp_output_4_0_g1684 );
				float temp_output_9_0_g1684 = sqrt( ( 1.0 - saturate( dotResult5_g1684 ) ) );
				float3 appendResult20_g1684 = (float3(break8_g1684.x , break8_g1684.y , temp_output_9_0_g1684));
				float3 temp_output_7028_0 = appendResult20_g1684;
				...
				float2 appendResult11_g1637 = (float2(texArray4828.w , texArray4828.y));
				float2 temp_output_4_0_g1637 = ( ( ( appendResult11_g1637 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1.0 ) );
				float2 break8_g1637 = temp_output_4_0_g1637;
				float dotResult5_g1637 = dot( temp_output_4_0_g1637 , temp_output_4_0_g1637 );
				float temp_output_9_0_g1637 = sqrt( ( 1.0 - saturate( dotResult5_g1637 ) ) );
				float3 appendResult21_g1637 = (float3(break8_g1637.y , break8_g1637.x , temp_output_9_0_g1637));
				...
				float2 appendResult11_g1652 = (float2(texArray4811.w , texArray4811.y));
				float2 temp_output_4_0_g1652 = ( ( ( appendResult11_g1652 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
				float2 break8_g1652 = temp_output_4_0_g1652;
				float dotResult5_g1652 = dot( temp_output_4_0_g1652 , temp_output_4_0_g1652 );
				float temp_output_9_0_g1652 = sqrt( ( 1.0 - saturate( dotResult5_g1652 ) ) );
				float3 appendResult20_g1652 = (float3(break8_g1652.x , break8_g1652.y , temp_output_9_0_g1652));
				float3 appendResult6951 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6464 = BlendComponents91;
				float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult21_g1637 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult20_g1652 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
				...
				float2 appendResult11_g1662 = (float2(texArray4870.w , texArray4870.y));
				float2 temp_output_4_0_g1662 = ( ( ( appendResult11_g1662 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
				float2 break8_g1662 = temp_output_4_0_g1662;
				float dotResult5_g1662 = dot( temp_output_4_0_g1662 , temp_output_4_0_g1662 );
				float temp_output_9_0_g1662 = sqrt( ( 1.0 - saturate( dotResult5_g1662 ) ) );
				float3 appendResult20_g1662 = (float3(break8_g1662.x , break8_g1662.y , temp_output_9_0_g1662));
				float3 temp_output_7025_0 = appendResult20_g1662;
				...
				float2 appendResult11_g1693 = (float2(texArray4850.w , texArray4850.y));
				float2 temp_output_4_0_g1693 = ( ( ( appendResult11_g1693 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1.0 ) );
				float2 break8_g1693 = temp_output_4_0_g1693;
				float dotResult5_g1693 = dot( temp_output_4_0_g1693 , temp_output_4_0_g1693 );
				float temp_output_9_0_g1693 = sqrt( ( 1.0 - saturate( dotResult5_g1693 ) ) );
				float3 appendResult21_g1693 = (float3(break8_g1693.y , break8_g1693.x , temp_output_9_0_g1693));
				...
				float2 appendResult11_g1667 = (float2(texArray4852.w , texArray4852.y));
				float2 temp_output_4_0_g1667 = ( ( ( appendResult11_g1667 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
				float2 break8_g1667 = temp_output_4_0_g1667;
				float dotResult5_g1667 = dot( temp_output_4_0_g1667 , temp_output_4_0_g1667 );
				float temp_output_9_0_g1667 = sqrt( ( 1.0 - saturate( dotResult5_g1667 ) ) );
				float3 appendResult20_g1667 = (float3(break8_g1667.x , break8_g1667.y , temp_output_9_0_g1667));
				float3 appendResult6944 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6471 = BlendComponents91;
				float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult21_g1693 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult20_g1667 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
				...
				float2 appendResult11_g1654 = (float2(texArray5120.w , texArray5120.y));
				float2 temp_output_4_0_g1654 = ( ( ( appendResult11_g1654 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
				float2 break8_g1654 = temp_output_4_0_g1654;
				float dotResult5_g1654 = dot( temp_output_4_0_g1654 , temp_output_4_0_g1654 );
				float temp_output_9_0_g1654 = sqrt( ( 1.0 - saturate( dotResult5_g1654 ) ) );
				float3 appendResult20_g1654 = (float3(break8_g1654.x , break8_g1654.y , temp_output_9_0_g1654));
				float3 temp_output_7022_0 = appendResult20_g1654;
				...
				float2 appendResult11_g1664 = (float2(texArray5127.w , texArray5127.y));
				float2 temp_output_4_0_g1664 = ( ( ( appendResult11_g1664 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1.0 ) );
				float2 break8_g1664 = temp_output_4_0_g1664;
				float dotResult5_g1664 = dot( temp_output_4_0_g1664 , temp_output_4_0_g1664 );
				float temp_output_9_0_g1664 = sqrt( ( 1.0 - saturate( dotResult5_g1664 ) ) );
				float3 appendResult21_g1664 = (float3(break8_g1664.y , break8_g1664.x , temp_output_9_0_g1664));
				...
				float2 appendResult11_g1639 = (float2(texArray5109.w , texArray5109.y));
				float2 temp_output_4_0_g1639 = ( ( ( appendResult11_g1639 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
				float2 break8_g1639 = temp_output_4_0_g1639;
				float dotResult5_g1639 = dot( temp_output_4_0_g1639 , temp_output_4_0_g1639 );
				float temp_output_9_0_g1639 = sqrt( ( 1.0 - saturate( dotResult5_g1639 ) ) );
				float3 appendResult20_g1639 = (float3(break8_g1639.x , break8_g1639.y , temp_output_9_0_g1639));
				float3 appendResult6937 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6478 = BlendComponents91;
				float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult21_g1664 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult20_g1639 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
				...
				float2 appendResult11_g1656 = (float2(texArray5178.w , texArray5178.y));
				float2 temp_output_4_0_g1656 = ( ( ( appendResult11_g1656 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
				float2 break8_g1656 = temp_output_4_0_g1656;
				float dotResult5_g1656 = dot( temp_output_4_0_g1656 , temp_output_4_0_g1656 );
				float temp_output_9_0_g1656 = sqrt( ( 1.0 - saturate( dotResult5_g1656 ) ) );
				float3 appendResult20_g1656 = (float3(break8_g1656.x , break8_g1656.y , temp_output_9_0_g1656));
				float3 temp_output_7019_0 = appendResult20_g1656;
				...
				float2 appendResult11_g1657 = (float2(texArray5017.w , texArray5017.y));
				float2 temp_output_4_0_g1657 = ( ( ( appendResult11_g1657 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1.0 ) );
				float2 break8_g1657 = temp_output_4_0_g1657;
				float dotResult5_g1657 = dot( temp_output_4_0_g1657 , temp_output_4_0_g1657 );
				float temp_output_9_0_g1657 = sqrt( ( 1.0 - saturate( dotResult5_g1657 ) ) );
				float3 appendResult21_g1657 = (float3(break8_g1657.y , break8_g1657.x , temp_output_9_0_g1657));
				...
				float2 appendResult11_g1658 = (float2(texArray5170.w , texArray5170.y));
				float2 temp_output_4_0_g1658 = ( ( ( appendResult11_g1658 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
				float2 break8_g1658 = temp_output_4_0_g1658;
				float dotResult5_g1658 = dot( temp_output_4_0_g1658 , temp_output_4_0_g1658 );
				float temp_output_9_0_g1658 = sqrt( ( 1.0 - saturate( dotResult5_g1658 ) ) );
				float3 appendResult20_g1658 = (float3(break8_g1658.x , break8_g1658.y , temp_output_9_0_g1658));
				float3 appendResult6930 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6485 = BlendComponents91;
				float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult21_g1657 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult20_g1658 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
				...
				float2 appendResult11_g1671 = (float2(texArray5246.w , texArray5246.y));
				float2 temp_output_4_0_g1671 = ( ( ( appendResult11_g1671 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
				float2 break8_g1671 = temp_output_4_0_g1671;
				float dotResult5_g1671 = dot( temp_output_4_0_g1671 , temp_output_4_0_g1671 );
				float temp_output_9_0_g1671 = sqrt( ( 1.0 - saturate( dotResult5_g1671 ) ) );
				float3 appendResult20_g1671 = (float3(break8_g1671.x , break8_g1671.y , temp_output_9_0_g1671));
				float3 temp_output_7016_0 = appendResult20_g1671;
				...
				float2 appendResult11_g1663 = (float2(texArray5227.w , texArray5227.y));
				float2 temp_output_4_0_g1663 = ( ( ( appendResult11_g1663 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1.0 ) );
				float2 break8_g1663 = temp_output_4_0_g1663;
				float dotResult5_g1663 = dot( temp_output_4_0_g1663 , temp_output_4_0_g1663 );
				float temp_output_9_0_g1663 = sqrt( ( 1.0 - saturate( dotResult5_g1663 ) ) );
				float3 appendResult21_g1663 = (float3(break8_g1663.y , break8_g1663.x , temp_output_9_0_g1663));
				...
				float2 appendResult11_g1636 = (float2(texArray5250.w , texArray5250.y));
				float2 temp_output_4_0_g1636 = ( ( ( appendResult11_g1636 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
				float2 break8_g1636 = temp_output_4_0_g1636;
				float dotResult5_g1636 = dot( temp_output_4_0_g1636 , temp_output_4_0_g1636 );
				float temp_output_9_0_g1636 = sqrt( ( 1.0 - saturate( dotResult5_g1636 ) ) );
				float3 appendResult20_g1636 = (float3(break8_g1636.x , break8_g1636.y , temp_output_9_0_g1636));
				float3 appendResult6923 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6492 = BlendComponents91;
				float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult21_g1663 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult20_g1636 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
				...
				float2 appendResult11_g1669 = (float2(texArray5099.w , texArray5099.y));
				float2 temp_output_4_0_g1669 = ( ( ( appendResult11_g1669 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
				float2 break8_g1669 = temp_output_4_0_g1669;
				float dotResult5_g1669 = dot( temp_output_4_0_g1669 , temp_output_4_0_g1669 );
				float temp_output_9_0_g1669 = sqrt( ( 1.0 - saturate( dotResult5_g1669 ) ) );
				float3 appendResult20_g1669 = (float3(break8_g1669.x , break8_g1669.y , temp_output_9_0_g1669));
				float3 temp_output_7013_0 = appendResult20_g1669;
				...
				float2 appendResult11_g1661 = (float2(texArray5082.w , texArray5082.y));
				float2 temp_output_4_0_g1661 = ( ( ( appendResult11_g1661 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1.0 ) );
				float2 break8_g1661 = temp_output_4_0_g1661;
				float dotResult5_g1661 = dot( temp_output_4_0_g1661 , temp_output_4_0_g1661 );
				float temp_output_9_0_g1661 = sqrt( ( 1.0 - saturate( dotResult5_g1661 ) ) );
				float3 appendResult21_g1661 = (float3(break8_g1661.y , break8_g1661.x , temp_output_9_0_g1661));
				...
				float2 appendResult11_g1678 = (float2(texArray4731.w , texArray4731.y));
				float2 temp_output_4_0_g1678 = ( ( ( appendResult11_g1678 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
				float2 break8_g1678 = temp_output_4_0_g1678;
				float dotResult5_g1678 = dot( temp_output_4_0_g1678 , temp_output_4_0_g1678 );
				float temp_output_9_0_g1678 = sqrt( ( 1.0 - saturate( dotResult5_g1678 ) ) );
				float3 appendResult20_g1678 = (float3(break8_g1678.x , break8_g1678.y , temp_output_9_0_g1678));
				float3 appendResult6916 = (float3(1.0 , ( WorldSpaceNormal.z * -1.0 ) , 1.0));
				float3 weightedBlendVar6499 = BlendComponents91;
				float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult21_g1661 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult20_g1678 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
				...
				float2 appendResult11_g1659 = (float2(texArray4382.w , texArray4382.y));
				float2 temp_output_4_0_g1659 = ( ( ( appendResult11_g1659 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
				float2 break8_g1659 = temp_output_4_0_g1659;
				float dotResult5_g1659 = dot( temp_output_4_0_g1659 , temp_output_4_0_g1659 );
				float temp_output_9_0_g1659 = sqrt( ( 1.0 - saturate( dotResult5_g1659 ) ) );
				float3 appendResult20_g1659 = (float3(break8_g1659.x , break8_g1659.y , temp_output_9_0_g1659));
				float3 ifLocalVar7798 = 0;
				UNITY_BRANCH 
				if( _Texture_Snow_Normal_Index <= -1.0 )
				ifLocalVar7798 = EmptyNRM7781;
				else
				ifLocalVar7798 = appendResult20_g1659;
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN  ) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float3 clampResult6387 = clamp( pow( abs( ( ase_worldNormal * ase_worldNormal ) ) , 25.0 ) , float3( -1,-1,-1 ) , float3( 1,1,1 ) );
           		half3 BlendComponents91 = clampResult6387;
           		float2 appendResult8003 = (float2(break8106.z , break8106.y));
           		half2 Front_Back1991 = appendResult8003;
           		float2 temp_output_5025_0 = ( Front_Back1991 * appendResult5027 );
	...
	Dependency "BaseMapShader"="CTS/URP/CTS Terrain Shader Advanced LOD"
