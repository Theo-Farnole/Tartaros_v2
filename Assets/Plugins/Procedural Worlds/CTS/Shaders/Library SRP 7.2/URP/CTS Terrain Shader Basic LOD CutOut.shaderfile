Shader "CTS/URP/CTS Terrain Shader Basic LOD CutOut"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v  )
        	{
				...
				float3 localCalculateTangentsSRP6206 = ( ( v.ase_tangent.xyz * 0.0 ) );
				...
				float3 vertexValue = localCalculateTangentsSRP6206;
    ...
    o.shadowCoord = GetShadowCoord(vertexInput);
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float3 break6186 = WorldSpacePosition;
				...
				float clampResult6207 = clamp( simplePerlin2D6191 , 0.0 , 1.0 );
				float lerpResult6192 = lerp( 1.0 , clampResult6207 , _Snow_Noise_Power);
				...
				float clampResult6167 = clamp( ( WorldSpacePosition.y + ( 0.0 - _Remove_Vert_Height ) ) , 0.0 , 1.0 );
				...
				float Alpha = ( tex2D( _TerrainHolesTexture, uv_TerrainHolesTexture ).r * clampResult6167 );
