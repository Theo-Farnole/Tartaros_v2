Shader "CTS/CTS Terrain Shader Advanced Tess CutOut"
{
	Properties
	{
		...
		[Toggle]_IsMesh("Is Mesh", Float) = 0
	...
	SubShader
	{
		...
		inline half MyCustomExpression8064( inout half3 In0 )
		{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float3 break8122 = ase_worldPos;
			float2 appendResult8055 = (half2(break8122.x , break8122.z));
			half2 Top_Bottom1999 = appendResult8055;
			...
			float2 appendResult8057 = (half2(break8122.z , break8122.y));
			half2 Front_Back1991 = appendResult8057;
			...
			float2 appendResult8056 = (half2(break8122.x , break8122.y));
			half2 Left_Right2003 = appendResult8056;
			...
			float simplePerlin2D8124 = snoise( ( Top_Bottom1999 * _Snow_Noise_Tiling ) );
			float lerpResult4310 = lerp( 1.0 , simplePerlin2D8124 , ( _Snow_Noise_Power * 0.1 ));
			...
			v.vertex.xyz += ( lerpResult7580 * ase_worldNormal );
			 v.tangent.xyz=lerp(cross( ase_worldNormal , half3(0,0,1) ),half3(0,0,0),_IsMesh);
			 v.tangent.w = -1;//;
		}
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult11_g1212 = (half2(texArray6256.w , texArray6256.y));
			float2 temp_output_4_0_g1212 = ( ( ( appendResult11_g1212 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float2 appendResult11_g1211 = (half2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g1211 = ( ( ( appendResult11_g1211 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			...
			float clampResult297 = clamp( pow( ( max( max( break8028.x , break8028.y ) , break8028.z ) / _UV_Mix_Start_Distance ) , _UV_Mix_Power ) , 0.0 , 1.0 );
			half UVmixDistance636 = clampResult297;
			float3 lerpResult6257 = lerp( appendResult20_g1212 , appendResult20_g1211 , UVmixDistance636);
			...
			float2 appendResult11_g1144 = (half2(texArray3300.w , texArray3300.y));
			float2 temp_output_4_0_g1144 = ( ( ( appendResult11_g1144 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 appendResult20_g1144 = (half3(break8_g1144.x , break8_g1144.y , temp_output_9_0_g1144));
			float3 temp_output_6989_0 = appendResult20_g1144;
			float4 texArray3299 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3279_0, _Texture_1_Normal_Index)  );
			float2 appendResult11_g571 = (half2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g571 = ( ( ( appendResult11_g571 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1.0 ) );
			float2 break8_g571 = temp_output_4_0_g571;
			float dotResult5_g571 = dot( temp_output_4_0_g571 , temp_output_4_0_g571 );
			float temp_output_9_0_g571 = sqrt( ( 1.0 - saturate( dotResult5_g571 ) ) );
			float3 appendResult21_g571 = (half3(break8_g571.y , break8_g571.x , temp_output_9_0_g571));
			...
			float2 appendResult11_g566 = (half2(texArray3301.w , texArray3301.y));
			float2 temp_output_4_0_g566 = ( ( ( appendResult11_g566 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			float2 break8_g566 = temp_output_4_0_g566;
			float dotResult5_g566 = dot( temp_output_4_0_g566 , temp_output_4_0_g566 );
			float temp_output_9_0_g566 = sqrt( ( 1.0 - saturate( dotResult5_g566 ) ) );
			float3 appendResult20_g566 = (half3(break8_g566.x , break8_g566.y , temp_output_9_0_g566));
			float3 appendResult6860 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6393 = BlendComponents91;
			float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult21_g571 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult20_g566 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
			...
			float2 appendResult11_g1155 = (half2(texArray3350.w , texArray3350.y));
			float2 temp_output_4_0_g1155 = ( ( ( appendResult11_g1155 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			...
			float3 appendResult20_g1155 = (half3(break8_g1155.x , break8_g1155.y , temp_output_9_0_g1155));
			float3 temp_output_6992_0 = appendResult20_g1155;
			float4 texArray3384 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3344_0, _Texture_2_Normal_Index)  );
			float2 appendResult11_g569 = (half2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g569 = ( ( ( appendResult11_g569 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1.0 ) );
			float2 break8_g569 = temp_output_4_0_g569;
			float dotResult5_g569 = dot( temp_output_4_0_g569 , temp_output_4_0_g569 );
			float temp_output_9_0_g569 = sqrt( ( 1.0 - saturate( dotResult5_g569 ) ) );
			float3 appendResult21_g569 = (half3(break8_g569.y , break8_g569.x , temp_output_9_0_g569));
			...
			float2 appendResult11_g568 = (half2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g568 = ( ( ( appendResult11_g568 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float2 break8_g568 = temp_output_4_0_g568;
			float dotResult5_g568 = dot( temp_output_4_0_g568 , temp_output_4_0_g568 );
			float temp_output_9_0_g568 = sqrt( ( 1.0 - saturate( dotResult5_g568 ) ) );
			float3 appendResult20_g568 = (half3(break8_g568.x , break8_g568.y , temp_output_9_0_g568));
			float3 appendResult6867 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6401 = BlendComponents91;
			float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult21_g569 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult20_g568 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
			...
			float2 appendResult11_g1151 = (half2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g1151 = ( ( ( appendResult11_g1151 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 appendResult20_g1151 = (half3(break8_g1151.x , break8_g1151.y , temp_output_9_0_g1151));
			float3 temp_output_6995_0 = appendResult20_g1151;
			float4 texArray3445 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3411_0, _Texture_3_Normal_Index)  );
			float2 appendResult11_g573 = (half2(texArray3445.w , texArray3445.y));
			float2 temp_output_4_0_g573 = ( ( ( appendResult11_g573 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1.0 ) );
			float2 break8_g573 = temp_output_4_0_g573;
			float dotResult5_g573 = dot( temp_output_4_0_g573 , temp_output_4_0_g573 );
			float temp_output_9_0_g573 = sqrt( ( 1.0 - saturate( dotResult5_g573 ) ) );
			float3 appendResult21_g573 = (half3(break8_g573.y , break8_g573.x , temp_output_9_0_g573));
			...
			float2 appendResult11_g572 = (half2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g572 = ( ( ( appendResult11_g572 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			float2 break8_g572 = temp_output_4_0_g572;
			float dotResult5_g572 = dot( temp_output_4_0_g572 , temp_output_4_0_g572 );
			float temp_output_9_0_g572 = sqrt( ( 1.0 - saturate( dotResult5_g572 ) ) );
			float3 appendResult20_g572 = (half3(break8_g572.x , break8_g572.y , temp_output_9_0_g572));
			float3 appendResult6874 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6408 = BlendComponents91;
			float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult21_g573 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult20_g572 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
			...
			float2 appendResult11_g1152 = (half2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g1152 = ( ( ( appendResult11_g1152 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult20_g1152 = (half3(break8_g1152.x , break8_g1152.y , temp_output_9_0_g1152));
			float3 temp_output_6998_0 = appendResult20_g1152;
			float4 texArray3512 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3478_0, _Texture_4_Normal_Index)  );
			float2 appendResult11_g570 = (half2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g570 = ( ( ( appendResult11_g570 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1.0 ) );
			float2 break8_g570 = temp_output_4_0_g570;
			float dotResult5_g570 = dot( temp_output_4_0_g570 , temp_output_4_0_g570 );
			float temp_output_9_0_g570 = sqrt( ( 1.0 - saturate( dotResult5_g570 ) ) );
			float3 appendResult21_g570 = (half3(break8_g570.y , break8_g570.x , temp_output_9_0_g570));
			...
			float2 appendResult11_g567 = (half2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g567 = ( ( ( appendResult11_g567 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			float2 break8_g567 = temp_output_4_0_g567;
			float dotResult5_g567 = dot( temp_output_4_0_g567 , temp_output_4_0_g567 );
			float temp_output_9_0_g567 = sqrt( ( 1.0 - saturate( dotResult5_g567 ) ) );
			float3 appendResult20_g567 = (half3(break8_g567.x , break8_g567.y , temp_output_9_0_g567));
			float3 appendResult6881 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6415 = BlendComponents91;
			float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult21_g570 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult20_g567 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
			...
			float2 appendResult11_g1177 = (half2(texArray4424.w , texArray4424.y));
			float2 temp_output_4_0_g1177 = ( ( ( appendResult11_g1177 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 appendResult20_g1177 = (half3(break8_g1177.x , break8_g1177.y , temp_output_9_0_g1177));
			float3 temp_output_7001_0 = appendResult20_g1177;
			float4 texArray4417 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4400_0, _Texture_5_Normal_Index)  );
			float2 appendResult11_g1149 = (half2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g1149 = ( ( ( appendResult11_g1149 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1149 = (half3(break8_g1149.y , break8_g1149.x , temp_output_9_0_g1149));
			...
			float2 appendResult11_g1150 = (half2(texArray4422.w , texArray4422.y));
			float2 temp_output_4_0_g1150 = ( ( ( appendResult11_g1150 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 appendResult20_g1150 = (half3(break8_g1150.x , break8_g1150.y , temp_output_9_0_g1150));
			float3 appendResult6888 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6422 = BlendComponents91;
			float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult21_g1149 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult20_g1150 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
			...
			float2 appendResult11_g1180 = (half2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g1180 = ( ( ( appendResult11_g1180 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 appendResult20_g1180 = (half3(break8_g1180.x , break8_g1180.y , temp_output_9_0_g1180));
			float3 temp_output_7004_0 = appendResult20_g1180;
			float4 texArray4486 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4472_0, _Texture_6_Normal_Index)  );
			float2 appendResult11_g1148 = (half2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g1148 = ( ( ( appendResult11_g1148 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1148 = (half3(break8_g1148.y , break8_g1148.x , temp_output_9_0_g1148));
			...
			float2 appendResult11_g1146 = (half2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g1146 = ( ( ( appendResult11_g1146 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 appendResult20_g1146 = (half3(break8_g1146.x , break8_g1146.y , temp_output_9_0_g1146));
			float3 appendResult6895 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6429 = BlendComponents91;
			float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult21_g1148 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult20_g1146 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
			...
			float2 appendResult11_g1181 = (half2(texArray4567.w , texArray4567.y));
			float2 temp_output_4_0_g1181 = ( ( ( appendResult11_g1181 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 appendResult20_g1181 = (half3(break8_g1181.x , break8_g1181.y , temp_output_9_0_g1181));
			float3 temp_output_7007_0 = appendResult20_g1181;
			float4 texArray4560 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4546_0, _Texture_7_Normal_Index)  );
			float2 appendResult11_g1147 = (half2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g1147 = ( ( ( appendResult11_g1147 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1147 = (half3(break8_g1147.y , break8_g1147.x , temp_output_9_0_g1147));
			...
			float2 appendResult11_g1145 = (half2(texArray4565.w , texArray4565.y));
			float2 temp_output_4_0_g1145 = ( ( ( appendResult11_g1145 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 appendResult20_g1145 = (half3(break8_g1145.x , break8_g1145.y , temp_output_9_0_g1145));
			float3 appendResult6902 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6436 = BlendComponents91;
			float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult21_g1147 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult20_g1145 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
			...
			float2 appendResult11_g1174 = (half2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g1174 = ( ( ( appendResult11_g1174 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 temp_output_7010_0 = appendResult20_g1174;
			float4 texArray4634 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4620_0, _Texture_8_Normal_Index)  );
			float2 appendResult11_g1154 = (half2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g1154 = ( ( ( appendResult11_g1154 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1154 = (half3(break8_g1154.y , break8_g1154.x , temp_output_9_0_g1154));
			...
			float2 appendResult11_g1153 = (half2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g1153 = ( ( ( appendResult11_g1153 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 appendResult20_g1153 = (half3(break8_g1153.x , break8_g1153.y , temp_output_9_0_g1153));
			float3 appendResult6909 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6443 = BlendComponents91;
			float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult21_g1154 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult20_g1153 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
			...
			float2 appendResult11_g1202 = (half2(texArray4788.w , texArray4788.y));
			...
			float3 appendResult20_g1202 = (half3(break8_g1202.x , break8_g1202.y , temp_output_9_0_g1202));
			...
			float2 appendResult11_g1170 = (half2(texArray5285.w , texArray5285.y));
			float2 temp_output_4_0_g1170 = ( ( ( appendResult11_g1170 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1170 = (half3(break8_g1170.y , break8_g1170.x , temp_output_9_0_g1170));
			...
			float2 appendResult11_g1169 = (half2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g1169 = ( ( ( appendResult11_g1169 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult21_g1170 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult20_g1169 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
			...
			float2 appendResult11_g1195 = (half2(texArray4822.w , texArray4822.y));
			float2 temp_output_4_0_g1195 = ( ( ( appendResult11_g1195 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 appendResult20_g1195 = (half3(break8_g1195.x , break8_g1195.y , temp_output_9_0_g1195));
			float3 temp_output_7031_0 = appendResult20_g1195;
			float4 texArray4798 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4742_0, _Texture_10_Normal_Index)  );
			float2 appendResult11_g1173 = (half2(texArray4798.w , texArray4798.y));
			float2 temp_output_4_0_g1173 = ( ( ( appendResult11_g1173 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1.0 ) );
			...
			float2 appendResult11_g1175 = (half2(texArray4791.w , texArray4791.y));
			...
			float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult21_g1173 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult20_g1175 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
			...
			float2 appendResult11_g1199 = (half2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g1199 = ( ( ( appendResult11_g1199 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 appendResult20_g1199 = (half3(break8_g1199.x , break8_g1199.y , temp_output_9_0_g1199));
			float3 temp_output_7028_0 = appendResult20_g1199;
			float4 texArray4828 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4748_0, _Texture_11_Normal_Index)  );
			float2 appendResult11_g1178 = (half2(texArray4828.w , texArray4828.y));
			...
			float3 appendResult21_g1178 = (half3(break8_g1178.y , break8_g1178.x , temp_output_9_0_g1178));
			...
			float2 appendResult11_g1179 = (half2(texArray4811.w , texArray4811.y));
			float2 temp_output_4_0_g1179 = ( ( ( appendResult11_g1179 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 appendResult20_g1179 = (half3(break8_g1179.x , break8_g1179.y , temp_output_9_0_g1179));
			float3 appendResult6951 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6464 = BlendComponents91;
			float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult21_g1178 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult20_g1179 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
			...
			float2 appendResult11_g1201 = (half2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g1201 = ( ( ( appendResult11_g1201 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 appendResult20_g1201 = (half3(break8_g1201.x , break8_g1201.y , temp_output_9_0_g1201));
			float3 temp_output_7025_0 = appendResult20_g1201;
			float4 texArray4850 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4758_0, _Texture_12_Normal_Index)  );
			float2 appendResult11_g1176 = (half2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g1176 = ( ( ( appendResult11_g1176 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1176 = (half3(break8_g1176.y , break8_g1176.x , temp_output_9_0_g1176));
			...
			float2 appendResult11_g1168 = (half2(texArray4852.w , texArray4852.y));
			float2 temp_output_4_0_g1168 = ( ( ( appendResult11_g1168 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult21_g1176 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult20_g1168 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
			...
			float2 appendResult11_g1209 = (half2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g1209 = ( ( ( appendResult11_g1209 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 appendResult21_g1197 = (half3(break8_g1197.y , break8_g1197.x , temp_output_9_0_g1197));
			...
			float2 appendResult11_g1204 = (half2(texArray5109.w , texArray5109.y));
			float2 temp_output_4_0_g1204 = ( ( ( appendResult11_g1204 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 appendResult6937 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 0.0));
			float3 weightedBlendVar6478 = BlendComponents91;
			float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult21_g1197 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult20_g1204 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
			...
			float2 appendResult11_g1207 = (half2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g1207 = ( ( ( appendResult11_g1207 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 temp_output_7019_0 = appendResult20_g1207;
			float4 texArray5017 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5009_0, _Texture_14_Normal_Index)  );
			float2 appendResult11_g1198 = (half2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g1198 = ( ( ( appendResult11_g1198 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1198 = (half3(break8_g1198.y , break8_g1198.x , temp_output_9_0_g1198));
			...
			float2 appendResult11_g1194 = (half2(texArray5170.w , texArray5170.y));
			float2 temp_output_4_0_g1194 = ( ( ( appendResult11_g1194 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 appendResult20_g1194 = (half3(break8_g1194.x , break8_g1194.y , temp_output_9_0_g1194));
			float3 appendResult6930 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6485 = BlendComponents91;
			float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult21_g1198 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult20_g1194 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
			...
			float2 appendResult11_g1206 = (half2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g1206 = ( ( ( appendResult11_g1206 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 appendResult20_g1206 = (half3(break8_g1206.x , break8_g1206.y , temp_output_9_0_g1206));
			float3 temp_output_7016_0 = appendResult20_g1206;
			float4 texArray5227 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5213_0, _Texture_15_Normal_Index)  );
			float2 appendResult11_g1203 = (half2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g1203 = ( ( ( appendResult11_g1203 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1203 = (half3(break8_g1203.y , break8_g1203.x , temp_output_9_0_g1203));
			...
			float2 appendResult11_g1200 = (half2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g1200 = ( ( ( appendResult11_g1200 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 appendResult20_g1200 = (half3(break8_g1200.x , break8_g1200.y , temp_output_9_0_g1200));
			float3 appendResult6923 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6492 = BlendComponents91;
			float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult21_g1203 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult20_g1200 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
			...
			float2 appendResult11_g1208 = (half2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g1208 = ( ( ( appendResult11_g1208 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 appendResult20_g1208 = (half3(break8_g1208.x , break8_g1208.y , temp_output_9_0_g1208));
			float3 temp_output_7013_0 = appendResult20_g1208;
			float4 texArray5082 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5079_0, _Texture_16_Normal_Index)  );
			float2 appendResult11_g1196 = (half2(texArray5082.w , texArray5082.y));
			float2 temp_output_4_0_g1196 = ( ( ( appendResult11_g1196 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1196 = (half3(break8_g1196.y , break8_g1196.x , temp_output_9_0_g1196));
			...
			float2 appendResult11_g1205 = (half2(texArray4731.w , texArray4731.y));
			float2 temp_output_4_0_g1205 = ( ( ( appendResult11_g1205 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 appendResult20_g1205 = (half3(break8_g1205.x , break8_g1205.y , temp_output_9_0_g1205));
			float3 appendResult6916 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6499 = BlendComponents91;
			float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult21_g1196 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult20_g1205 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
			...
			float2 appendResult11_g1210 = (half2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g1210 = ( ( ( appendResult11_g1210 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			...
			if( _Texture_Snow_Normal_Index <= 0.0 )
				...
				ifLocalVar7819 = appendResult20_g1210;
			...
			float clampResult8116 = clamp( ( tex2DNode8036.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0.0 , 1.0 );
			float2 appendResult8038 = (half2(1.0 , ( lerpResult8035 * clampResult8116 )));
			...
			float3 appendResult8037 = (half3(tex2DNode8036.r , tex2DNode8036.g , tex2DNode8036.b));
			...
			half4 tex2DNode8032 = tex2D( _Texture_Geological_Map, temp_cast_2 );
			float3 appendResult6970 = (half3(tex2DNode8032.r , tex2DNode8032.g , tex2DNode8032.b));
			...
			half3 In08064 = float3( 0,0,0 );
			half localMyCustomExpression8064 = MyCustomExpression8064( In08064 );
			float3 break8063 = _WorldSpaceCameraPos;
			float temp_output_8070_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression8064 * 10.0 ) + ( break8063.x + break8063.y + break8063.z ) ) );
			float temp_output_8073_0 = ( 0.0 + temp_output_8070_0 );
			float clampResult8090 = clamp( sin( ( temp_output_8073_0 * 0.1 ) ) , 0.0 , 1.0 );
			float2 temp_output_8076_0 = ( Top_Bottom1999 * ( 1.0 / _Glitter_Tiling ) );
			float2 break8112 = temp_output_8076_0;
			float2 appendResult8111 = (half2(break8112.y , break8112.x));
			half4 tex2DNode8092 = tex2D( _Texture_Glitter, ( appendResult8111 + float2( 0.37,0.67 ) ) );
			float2 panner8077 = ( ( temp_output_8070_0 * 0.01 ) * float2( 1,1 ) + temp_output_8076_0);
			...
			float clampResult8094 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator8079 + temp_output_8076_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0.0 , 1.0 );
			float lerpResult8096 = lerp(  ( clampResult8090 - 0.2 > 0.0 ? tex2D( _Texture_Glitter, temp_output_8076_0 ).r : clampResult8090 - 0.2 <= 0.0 && clampResult8090 + 0.2 >= 0.0 ? tex2DNode8092.r : tex2DNode8092.r )  , 0.6 , clampResult8094);
			float clampResult8100 = clamp( pow( lerpResult8096 , 100.0 ) , 0.0 , 1.0 );
			...
			float clampResult8106 = clamp( temp_output_8101_0 , 0.0 , 1.0 );
			...
			float lerpResult8107 = lerp( break1409.w , _Glitter_Smoothness , clampResult8106);
			float lerpResult3951 = lerp( ( break3856.w * _Terrain_Smoothness ) , lerpResult8107 , HeightMask6539);
			...
			float clampResult8047 = clamp( ( ase_worldPos.y + ( 0.0 - _Remove_Vert_Height ) ) , 0.0 , 1.0 );
			clip( ( tex2D( _TerrainHolesTexture, uv_TerrainHolesTexture ).r * clampResult8047 ) - _Cutoff );
		}
