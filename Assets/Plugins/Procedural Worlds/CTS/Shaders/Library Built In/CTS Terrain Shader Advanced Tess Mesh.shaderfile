Shader "CTS/CTS Terrain Shader Advanced Tess Mesh"
{
	...
	SubShader
	{
		...
		inline half MyCustomExpression8074( inout half3 In0 )
		{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float3 break8124 = ase_worldPos;
			float2 appendResult8063 = (half2(break8124.x , break8124.z));
			half2 Top_Bottom1999 = appendResult8063;
			...
			float2 appendResult8061 = (half2(break8124.z , break8124.y));
			half2 Front_Back1991 = appendResult8061;
			...
			float2 appendResult8062 = (half2(break8124.x , break8124.y));
			...
			float simplePerlin2D8126 = snoise( ( Top_Bottom1999 * _Snow_Noise_Tiling ) );
			float lerpResult4310 = lerp( 1.0 , simplePerlin2D8126 , ( _Snow_Noise_Power * 0.1 ));
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult11_g1222 = (half2(texArray6256.w , texArray6256.y));
			float2 temp_output_4_0_g1222 = ( ( ( appendResult11_g1222 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			float2 break8_g1222 = temp_output_4_0_g1222;
			float dotResult5_g1222 = dot( temp_output_4_0_g1222 , temp_output_4_0_g1222 );
			float temp_output_9_0_g1222 = sqrt( ( 1.0 - saturate( dotResult5_g1222 ) ) );
			float3 appendResult20_g1222 = (half3(break8_g1222.x , break8_g1222.y , temp_output_9_0_g1222));
			...
			float2 appendResult11_g1221 = (half2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g1221 = ( ( ( appendResult11_g1221 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			...
			float3 appendResult20_g1221 = (half3(break8_g1221.x , break8_g1221.y , temp_output_9_0_g1221));
			float3 break8028 = abs( ( ase_worldPos - _WorldSpaceCameraPos ) );
			float clampResult297 = clamp( pow( ( max( max( break8028.x , break8028.y ) , break8028.z ) / _UV_Mix_Start_Distance ) , _UV_Mix_Power ) , 0.0 , 1.0 );
			half UVmixDistance636 = clampResult297;
			float3 lerpResult6257 = lerp( appendResult20_g1222 , appendResult20_g1221 , UVmixDistance636);
			...
			float2 appendResult11_g1131 = (half2(texArray3300.w , texArray3300.y));
			float2 temp_output_4_0_g1131 = ( ( ( appendResult11_g1131 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			float2 break8_g1131 = temp_output_4_0_g1131;
			...
			float3 appendResult20_g1131 = (half3(break8_g1131.x , break8_g1131.y , temp_output_9_0_g1131));
			float3 temp_output_6989_0 = appendResult20_g1131;
			float4 texArray3299 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3279_0, _Texture_1_Normal_Index)  );
			float2 appendResult11_g570 = (half2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g570 = ( ( ( appendResult11_g570 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1.0 ) );
			...
			float2 appendResult11_g572 = (half2(texArray3301.w , texArray3301.y));
			float2 temp_output_4_0_g572 = ( ( ( appendResult11_g572 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult21_g570 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult20_g572 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
			...
			float2 appendResult11_g1136 = (half2(texArray3350.w , texArray3350.y));
			float2 temp_output_4_0_g1136 = ( ( ( appendResult11_g1136 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float2 break8_g1136 = temp_output_4_0_g1136;
			...
			float3 appendResult20_g1136 = (half3(break8_g1136.x , break8_g1136.y , temp_output_9_0_g1136));
			float3 temp_output_6992_0 = appendResult20_g1136;
			float4 texArray3384 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3344_0, _Texture_2_Normal_Index)  );
			float2 appendResult11_g574 = (half2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g574 = ( ( ( appendResult11_g574 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1.0 ) );
			float2 break8_g574 = temp_output_4_0_g574;
			float dotResult5_g574 = dot( temp_output_4_0_g574 , temp_output_4_0_g574 );
			float temp_output_9_0_g574 = sqrt( ( 1.0 - saturate( dotResult5_g574 ) ) );
			float3 appendResult21_g574 = (half3(break8_g574.y , break8_g574.x , temp_output_9_0_g574));
			...
			float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult21_g574 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult20_g568 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
			...
			float2 appendResult11_g1134 = (half2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g1134 = ( ( ( appendResult11_g1134 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			float2 break8_g1134 = temp_output_4_0_g1134;
			...
			float3 appendResult20_g1134 = (half3(break8_g1134.x , break8_g1134.y , temp_output_9_0_g1134));
			float3 temp_output_6995_0 = appendResult20_g1134;
			...
			float2 appendResult11_g575 = (half2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g575 = ( ( ( appendResult11_g575 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			float2 break8_g575 = temp_output_4_0_g575;
			float dotResult5_g575 = dot( temp_output_4_0_g575 , temp_output_4_0_g575 );
			float temp_output_9_0_g575 = sqrt( ( 1.0 - saturate( dotResult5_g575 ) ) );
			float3 appendResult20_g575 = (half3(break8_g575.x , break8_g575.y , temp_output_9_0_g575));
			float3 appendResult6874 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6408 = BlendComponents91;
			float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult21_g573 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult20_g575 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
			...
			float2 appendResult11_g1128 = (half2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g1128 = ( ( ( appendResult11_g1128 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult20_g1128 = (half3(break8_g1128.x , break8_g1128.y , temp_output_9_0_g1128));
			float3 temp_output_6998_0 = appendResult20_g1128;
			float4 texArray3512 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3478_0, _Texture_4_Normal_Index)  );
			float2 appendResult11_g569 = (half2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g569 = ( ( ( appendResult11_g569 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1.0 ) );
			...
			float2 appendResult11_g571 = (half2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g571 = ( ( ( appendResult11_g571 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult20_g571 = (half3(break8_g571.x , break8_g571.y , temp_output_9_0_g571));
			float3 appendResult6881 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6415 = BlendComponents91;
			float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult21_g569 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult20_g571 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
			...
			float2 appendResult11_g1165 = (half2(texArray4424.w , texArray4424.y));
			float2 temp_output_4_0_g1165 = ( ( ( appendResult11_g1165 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 temp_output_7001_0 = appendResult20_g1165;
			float4 texArray4417 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4400_0, _Texture_5_Normal_Index)  );
			float2 appendResult11_g1127 = (half2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g1127 = ( ( ( appendResult11_g1127 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1127 = (half3(break8_g1127.y , break8_g1127.x , temp_output_9_0_g1127));
			...
			float2 appendResult11_g1133 = (half2(texArray4422.w , texArray4422.y));
			float2 temp_output_4_0_g1133 = ( ( ( appendResult11_g1133 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			float2 break8_g1133 = temp_output_4_0_g1133;
			...
			float3 appendResult20_g1133 = (half3(break8_g1133.x , break8_g1133.y , temp_output_9_0_g1133));
			float3 appendResult6888 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6422 = BlendComponents91;
			float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult21_g1127 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult20_g1133 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
			...
			float2 appendResult11_g1176 = (half2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g1176 = ( ( ( appendResult11_g1176 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 temp_output_7004_0 = appendResult20_g1176;
			float4 texArray4486 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4472_0, _Texture_6_Normal_Index)  );
			float2 appendResult11_g1132 = (half2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g1132 = ( ( ( appendResult11_g1132 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1.0 ) );
			float2 break8_g1132 = temp_output_4_0_g1132;
			...
			float3 appendResult21_g1132 = (half3(break8_g1132.y , break8_g1132.x , temp_output_9_0_g1132));
			...
			float2 appendResult11_g1130 = (half2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g1130 = ( ( ( appendResult11_g1130 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			float2 break8_g1130 = temp_output_4_0_g1130;
			...
			float3 appendResult20_g1130 = (half3(break8_g1130.x , break8_g1130.y , temp_output_9_0_g1130));
			float3 appendResult6895 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6429 = BlendComponents91;
			float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult21_g1132 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult20_g1130 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
			...
			float2 appendResult11_g1178 = (half2(texArray4567.w , texArray4567.y));
			float2 temp_output_4_0_g1178 = ( ( ( appendResult11_g1178 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 appendResult20_g1178 = (half3(break8_g1178.x , break8_g1178.y , temp_output_9_0_g1178));
			float3 temp_output_7007_0 = appendResult20_g1178;
			float4 texArray4560 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4546_0, _Texture_7_Normal_Index)  );
			float2 appendResult11_g1129 = (half2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g1129 = ( ( ( appendResult11_g1129 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1.0 ) );
			float2 break8_g1129 = temp_output_4_0_g1129;
			...
			float3 appendResult21_g1129 = (half3(break8_g1129.y , break8_g1129.x , temp_output_9_0_g1129));
			...
			float2 appendResult11_g1126 = (half2(texArray4565.w , texArray4565.y));
			...
			float3 appendResult20_g1126 = (half3(break8_g1126.x , break8_g1126.y , temp_output_9_0_g1126));
			float3 appendResult6902 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6436 = BlendComponents91;
			float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult21_g1129 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult20_g1126 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
			...
			float2 appendResult11_g1171 = (half2(texArray4641.w , texArray4641.y));
			...
			float3 appendResult20_g1171 = (half3(break8_g1171.x , break8_g1171.y , temp_output_9_0_g1171));
			float3 temp_output_7010_0 = appendResult20_g1171;
			float4 texArray4634 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4620_0, _Texture_8_Normal_Index)  );
			float2 appendResult11_g1137 = (half2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g1137 = ( ( ( appendResult11_g1137 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1.0 ) );
			float2 break8_g1137 = temp_output_4_0_g1137;
			...
			float3 appendResult21_g1137 = (half3(break8_g1137.y , break8_g1137.x , temp_output_9_0_g1137));
			...
			float2 appendResult11_g1135 = (half2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g1135 = ( ( ( appendResult11_g1135 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			float2 break8_g1135 = temp_output_4_0_g1135;
			...
			float3 appendResult20_g1135 = (half3(break8_g1135.x , break8_g1135.y , temp_output_9_0_g1135));
			float3 appendResult6909 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6443 = BlendComponents91;
			float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult21_g1137 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult20_g1135 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
			...
			float2 appendResult11_g1205 = (half2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g1205 = ( ( ( appendResult11_g1205 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 temp_output_7034_0 = appendResult20_g1205;
			float4 texArray5285 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4706_0, _Texture_9_Normal_Index)  );
			float2 appendResult11_g1174 = (half2(texArray5285.w , texArray5285.y));
			float2 temp_output_4_0_g1174 = ( ( ( appendResult11_g1174 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1174 = (half3(break8_g1174.y , break8_g1174.x , temp_output_9_0_g1174));
			...
			float2 appendResult11_g1170 = (half2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g1170 = ( ( ( appendResult11_g1170 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult21_g1174 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult20_g1170 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
			...
			float2 appendResult11_g1211 = (half2(texArray4822.w , texArray4822.y));
			float2 temp_output_4_0_g1211 = ( ( ( appendResult11_g1211 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 temp_output_7031_0 = appendResult20_g1211;
			...
			float2 appendResult11_g1179 = (half2(texArray4791.w , texArray4791.y));
			float2 temp_output_4_0_g1179 = ( ( ( appendResult11_g1179 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult21_g1173 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult20_g1179 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
			...
			float2 appendResult11_g1204 = (half2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g1204 = ( ( ( appendResult11_g1204 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 temp_output_7028_0 = appendResult20_g1204;
			float4 texArray4828 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4748_0, _Texture_11_Normal_Index)  );
			float2 appendResult11_g1175 = (half2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g1175 = ( ( ( appendResult11_g1175 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1175 = (half3(break8_g1175.y , break8_g1175.x , temp_output_9_0_g1175));
			...
			float2 appendResult11_g1172 = (half2(texArray4811.w , texArray4811.y));
			float2 temp_output_4_0_g1172 = ( ( ( appendResult11_g1172 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult21_g1175 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult20_g1172 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
			...
			float2 appendResult11_g1208 = (half2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g1208 = ( ( ( appendResult11_g1208 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 temp_output_7025_0 = appendResult20_g1208;
			float4 texArray4850 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4758_0, _Texture_12_Normal_Index)  );
			float2 appendResult11_g1164 = (half2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g1164 = ( ( ( appendResult11_g1164 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1164 = (half3(break8_g1164.y , break8_g1164.x , temp_output_9_0_g1164));
			...
			float2 appendResult11_g1177 = (half2(texArray4852.w , texArray4852.y));
			float2 temp_output_4_0_g1177 = ( ( ( appendResult11_g1177 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult21_g1164 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult20_g1177 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
			...
			float2 appendResult11_g1216 = (half2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g1216 = ( ( ( appendResult11_g1216 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 appendResult20_g1216 = (half3(break8_g1216.x , break8_g1216.y , temp_output_9_0_g1216));
			float3 temp_output_7022_0 = appendResult20_g1216;
			float4 texArray5127 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5025_0, _Texture_13_Normal_Index)  );
			float2 appendResult11_g1212 = (half2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g1212 = ( ( ( appendResult11_g1212 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1212 = (half3(break8_g1212.y , break8_g1212.x , temp_output_9_0_g1212));
			...
			float2 appendResult11_g1206 = (half2(texArray5109.w , texArray5109.y));
			float2 temp_output_4_0_g1206 = ( ( ( appendResult11_g1206 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult21_g1212 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult20_g1206 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
			...
			float2 appendResult11_g1219 = (half2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g1219 = ( ( ( appendResult11_g1219 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 appendResult20_g1219 = (half3(break8_g1219.x , break8_g1219.y , temp_output_9_0_g1219));
			float3 temp_output_7019_0 = appendResult20_g1219;
			float4 texArray5017 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5009_0, _Texture_14_Normal_Index)  );
			float2 appendResult11_g1213 = (half2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g1213 = ( ( ( appendResult11_g1213 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1213 = (half3(break8_g1213.y , break8_g1213.x , temp_output_9_0_g1213));
			...
			float2 appendResult11_g1210 = (half2(texArray5170.w , texArray5170.y));
			float2 temp_output_4_0_g1210 = ( ( ( appendResult11_g1210 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult21_g1213 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult20_g1210 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
			...
			float2 appendResult11_g1217 = (half2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g1217 = ( ( ( appendResult11_g1217 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 appendResult20_g1217 = (half3(break8_g1217.x , break8_g1217.y , temp_output_9_0_g1217));
			float3 temp_output_7016_0 = appendResult20_g1217;
			float4 texArray5227 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5213_0, _Texture_15_Normal_Index)  );
			float2 appendResult11_g1214 = (half2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g1214 = ( ( ( appendResult11_g1214 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1214 = (half3(break8_g1214.y , break8_g1214.x , temp_output_9_0_g1214));
			...
			float2 appendResult11_g1209 = (half2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g1209 = ( ( ( appendResult11_g1209 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult21_g1214 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult20_g1209 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
			...
			float2 appendResult11_g1218 = (half2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g1218 = ( ( ( appendResult11_g1218 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 appendResult20_g1218 = (half3(break8_g1218.x , break8_g1218.y , temp_output_9_0_g1218));
			float3 temp_output_7013_0 = appendResult20_g1218;
			float4 texArray5082 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5079_0, _Texture_16_Normal_Index)  );
			float2 appendResult11_g1207 = (half2(texArray5082.w , texArray5082.y));
			float2 temp_output_4_0_g1207 = ( ( ( appendResult11_g1207 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g1207 = (half3(break8_g1207.y , break8_g1207.x , temp_output_9_0_g1207));
			...
			float2 appendResult11_g1215 = (half2(texArray4731.w , texArray4731.y));
			...
			float3 appendResult20_g1215 = (half3(break8_g1215.x , break8_g1215.y , temp_output_9_0_g1215));
			float3 appendResult6916 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar6499 = BlendComponents91;
			float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult21_g1207 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult20_g1215 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
			...
			float2 appendResult11_g1220 = (half2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g1220 = ( ( ( appendResult11_g1220 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			...
			float3 appendResult20_g1220 = (half3(break8_g1220.x , break8_g1220.y , temp_output_9_0_g1220));
			half3 ifLocalVar7819 = 0;
			UNITY_BRANCH 
			if( _Texture_Snow_Normal_Index <= 0.0 )
				ifLocalVar7819 = EmptyNRM7829;
			else
				ifLocalVar7819 = appendResult20_g1220;
			...
			half3 In08074 = float3( 0,0,0 );
			half localMyCustomExpression8074 = MyCustomExpression8074( In08074 );
			float3 break8073 = _WorldSpaceCameraPos;
			float temp_output_8078_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression8074 * 10.0 ) + ( break8073.x + break8073.y + break8073.z ) ) );
			float temp_output_8081_0 = ( 0.0 + temp_output_8078_0 );
			float clampResult8093 = clamp( sin( ( temp_output_8081_0 * 0.1 ) ) , 0.0 , 1.0 );
			float2 temp_output_8084_0 = ( Top_Bottom1999 * ( 1.0 / _Glitter_Tiling ) );
			float2 break8117 = temp_output_8084_0;
			float2 appendResult8116 = (half2(break8117.y , break8117.x));
			half4 tex2DNode8095 = tex2D( _Texture_Glitter, ( appendResult8116 + float2( 0.37,0.67 ) ) );
			float2 panner8085 = ( ( temp_output_8078_0 * 0.01 ) * float2( 1,1 ) + temp_output_8084_0);
			...
			float clampResult8097 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator8087 + temp_output_8084_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0.0 , 1.0 );
			float lerpResult8098 = lerp(  ( clampResult8093 - 0.2 > 0.0 ? tex2D( _Texture_Glitter, temp_output_8084_0 ).r : clampResult8093 - 0.2 <= 0.0 && clampResult8093 + 0.2 >= 0.0 ? tex2DNode8095.r : tex2DNode8095.r )  , 0.6 , clampResult8097);
			float clampResult8100 = clamp( pow( lerpResult8098 , 100.0 ) , 0.0 , 1.0 );
			...
			float clampResult8102 = clamp( temp_output_8101_0 , 0.0 , 1.0 );
			...
			float lerpResult8103 = lerp( break1409.w , _Glitter_Smoothness , clampResult8102);
