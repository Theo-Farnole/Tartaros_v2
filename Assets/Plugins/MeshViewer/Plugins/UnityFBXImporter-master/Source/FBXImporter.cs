namespace Plugins.FBXImporter
{
	...
	{
		#region Fields
		private readonly char[] white = new char[] { ' ', '\n', '\t', '\r' };
		private readonly char[] newLn = new char[] { '\n', '\r' };
		private readonly char[] comma = new char[] { ',' };
		private readonly char[] mlArr = new char[] { '\t', '}' };
		...
		private List<ClassImpMesh> impMeshes = null;
		private static List<ClassImportedModel> impModels = null;

		private string fileCompl = null;
		...
		#region Methods
		public GameObject ParseFBX(string path)
		{
