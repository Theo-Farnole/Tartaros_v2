...
Shader "Tartaros/SH_CosmicSmoke"
{
	Properties
	{
		...
		_PaternStrength("PaternStrength", Float) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float Patern146 = ( ( ( ( 1.0 - voroi315 ) + voroi317 ) * 0.77 ) * ( ( 1.0 - smoothstepResult144 ) * _PaternStrength ) );
			float time152 = 0.0;
			...
			float lerpResult194 = lerp( Patern146 , ( 1.0 - ( ( Patern146 - ( ( 1.0 - smoothstepResult155 ) * 2.0 ) ) + 0.5 ) ) , 0.5);
			...
			float lerpResult217 = lerp( Patern146 , ( 1.0 - ( ( Patern146 - ( ( 1.0 - smoothstepResult210 ) * 2.0 ) ) + 0.5 ) ) , 0.5);
			float Albedo2220 = saturate( lerpResult217 );
			float lerpResult283 = lerp( Albedo1196 , Albedo2220 , 0.5);
			float time229 = 0.0;
			...
			float lerpResult237 = lerp( Patern146 , ( 1.0 - ( ( Patern146 - ( ( 1.0 - smoothstepResult230 ) * 2.0 ) ) + 0.5 ) ) , 0.5);
			float Albedo3240 = saturate( lerpResult237 );
			float lerpResult281 = lerp( lerpResult283 , Albedo3240 , 0.5);
			float time249 = 0.0;
			...
			float lerpResult257 = lerp( Patern146 , ( 1.0 - ( ( Patern146 - ( ( 1.0 - smoothstepResult250 ) * 2.0 ) ) + 0.5 ) ) , 0.5);
			float Albedo4260 = saturate( lerpResult257 );
			float lerpResult284 = lerp( lerpResult281 , Albedo4260 , 0.5);
			float time269 = 0.0;
			...
			float lerpResult277 = lerp( Patern146 , ( 1.0 - ( ( Patern146 - ( ( 1.0 - smoothstepResult270 ) * 2.0 ) ) + 0.5 ) ) , 0.5);
			float Albedo5280 = saturate( lerpResult277 );
			float lerpResult282 = lerp( lerpResult284 , Albedo5280 , 0.5);
			...
			#endif //aselc
			float4 Contrasted297 = saturate( ( float4( ( ( ( 1.0 - ( _Contrast + Albedo185 ) ) * _Brightness ) + ( ase_lightColor.rgb * ( ase_lightColor.a * 0.1 ) ) ) , 0.0 ) * i.vertexColor ) );
			o.Albedo = Contrasted297.rgb;
...
/*ASEBEGIN
Version=18500
272;73;1265;549;4840.313;2501.51;1.648138;True;False
Node;AmplifyShaderEditor.CommentaryNode;200;-2351.523,-3878.108;Inherit;False;3769.276;519.2332;Comment;19;166;149;126;165;124;125;127;152;155;153;154;190;191;192;193;194;195;197;196;Patern1;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;126;-2301.523,-3554.574;Inherit;False;Property;_Offset;Offset;2;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldToTangentMatrix;121;-4475.018,-1284.369;Inherit;False;0;1;FLOAT3x3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;120;-4167.447,-1403.111;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3x3;0,0,0,0,1,0,0,0,1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TimeNode;323;-5235.22,-2160.242;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;201;-2335.596,-3131.636;Inherit;False;3769.276;519.2332;Comment;17;220;219;218;217;216;215;214;213;212;211;210;209;208;207;206;203;202;Patern2;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;322;-4899.171,-2420.383;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VoronoiNode;315;-4409.591,-2436.183;Inherit;True;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;5;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.Vector2Node;300;-4369.604,-1691.991;Inherit;False;Property;_PaternSmoothStep;PaternSmoothStep;5;0;Create;True;0;0;False;0;False;0,0.1;0,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.CommentaryNode;221;-2342.667,-2367.93;Inherit;False;3769.276;519.2332;Comment;17;240;239;238;237;236;235;234;233;232;231;230;229;228;227;226;223;222;Patern3;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;241;-2305.392,-1644.878;Inherit;False;3769.276;519.2332;Comment;17;260;259;258;257;256;255;254;253;252;251;250;249;248;247;246;243;242;Patern4;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.VoronoiNode;317;-4400.734,-2164.401;Inherit;True;0;0;1;0;8;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;5;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.OneMinusNode;316;-4136.835,-2379.249;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;261;-2291.158,-919.0053;Inherit;False;3769.276;519.2332;Comment;17;280;279;278;277;276;275;274;273;272;271;270;269;268;267;266;263;262;Patern5;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;320;-3926.771,-2158.923;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;301;-4148.42,-1593.401;Inherit;False;Property;_PaternStrength;PaternStrength;6;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;318;-3629.263,-2145.18;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0.77;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;197;-332.896,-3773.883;Inherit;False;146;Patern;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;295;-1161.931,786.4698;Inherit;False;Property;_Brightness;Brightness;4;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;296;176.7405,695.3314;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;199;332.3403,-74.35327;Inherit;True;297;Contrasted;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;314;-2961.44,-1856.916;Inherit;True;Property;_TextureSample0;Texture Sample 0;7;0;Create;True;0;0;False;0;False;-1;None;0000000000000000f000000000000000;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;107;647.999,-68.38998;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Tartaros/SH_CosmicSmoke;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;-0.16;True;True;0;False;Transparent;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;107;0;199;0
WireConnection;107;9;299;0
ASEEND*/
//CHKSM=3052B0BB7C27456B0F45E0D557963B1389DE806C