...
return F1;
		...
		{
			float2 temp_cast_0 = (_TextureScale).xx;
			...
			o.Emission = ( texCUBE( _CubeMap, ( i.viewDir + float3( uv_TexCoord211 ,  0.0 ) ) ) + ( _Step * tex2D( _TextureSample0, ( ( 1.0 - uv_TexCoord204 ) * _StarScale ) ) ) + ( _FresnelColor2 * pow( ( fresnelNode176 * voroi164 ) , _Voro2Power ) ) ).rgb;
...
/*ASEBEGIN
Version=18500
253;73;1321;615;3185.396;1358.66;1.049213;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;212;-2652.349,-920.818;Inherit;False;Property;_TextureScale;TextureScale;16;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;196;-2004.996,-761.5972;Inherit;False;Property;_Step;Step;14;0;Create;True;0;0;False;0;False;10;-2.32;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;208;-2852.588,-906.853;Inherit;False;Property;_TextureTiling2;TextureTiling;13;0;Create;True;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
ASEEND*/
//CHKSM=EE72CAC8E3802A06B65720628C596084A9767FDA