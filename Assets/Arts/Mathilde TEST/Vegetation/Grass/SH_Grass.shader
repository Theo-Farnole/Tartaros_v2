...
Shader "SH_Grass_01"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			Gradient gradient261 = NewGradient( 0, 3, 2, float4( 0.8301887, 0.2182383, 0.1605553, 0.1470665 ), float4( 0.9150943, 0.1424439, 0.7624308, 0.4705882 ), float4( 0, 0.6993538, 0.9811321, 1 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
			...
			float4 lerpResult12 = lerp( color256 , SampleGradient( gradient261, lerpResult10_g8 ) , CalculateContrast(5.0,temp_cast_0));
...
/*ASEBEGIN
Version=18500
3;4;1915;1007;1583.531;1081.176;1;True;False
...
ASEEND*/
//CHKSM=B361DC0A1525CAB29DF0D763A199247654A32B16