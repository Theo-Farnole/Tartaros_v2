...
#define _EnableFakeFoWProjection_arr TartarosSH_Leaves
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color345 = IsGammaSpace() ? float4(0,0.199,0.1567646,1) : float4(0,0.03279405,0.02119542,1);
			Gradient gradient261 = NewGradient( 1, 5, 2, float4( 0.7686275, 0.4431373, 0.2980392, 0.09706264 ), float4( 0.7058824, 0.5490196, 0.3019608, 0.202945 ), float4( 0.3137255, 0.4705883, 0.2313726, 0.4500038 ), float4( 0.2789308, 0.4056604, 0.2123976, 0.7470664 ), float4( 0.3407227, 0.5188679, 0.2471965, 1 ), 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
...
/*ASEBEGIN
Version=18500
833;143;1920;1013;229.6577;680.1536;1;True;False
...
Node;AmplifyShaderEditor.GradientNode;261;-394.2625,-314.7717;Inherit;False;1;5;2;0.7686275,0.4431373,0.2980392,0.09706264;0.7058824,0.5490196,0.3019608,0.202945;0.3137255,0.4705883,0.2313726,0.4500038;0.2789308,0.4056604,0.2123976,0.7470664;0.3407227,0.5188679,0.2471965,1;1,0;1,1;0;1;OBJECT;0
...
Node;AmplifyShaderEditor.ColorNode;345;352.988,-463.9645;Inherit;False;Constant;_FakeFoWProjectionColor;FakeFoWProjectionColor;15;0;Create;True;0;0;False;0;False;0,0.199,0.1567646,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=AA4F9CAE1E7187C21873916F68E1B23E2683B0D1