namespace Tartaros.Map
{
	...
	public static class PolygonMeshGenerator
	{
		...
		{
			var vertices3D = System.Array.ConvertAll<Vector2, Vector3>(convexPolygon.vertices.ToArray(), v => v);

			// exemple: https://gist.github.com/Hyperparticle/68586a8834ed6cafd4a1b2ba32ccf6ed
			var triangulator = new Triangulator(convexPolygon.vertices.ToArray());
