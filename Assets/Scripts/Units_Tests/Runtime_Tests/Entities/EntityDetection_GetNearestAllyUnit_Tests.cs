namespace Tartaros.Tests
{
	...
	public class EntityDetection_GetNearestAllyUnit_Tests
	{
		#region Fields
		...
		[UnityTest]
		public IEnumerator When_AllyIsUnit_Should_ReturnTrue()
		{
			yield return SetupTwoAllies(EntityType.Unit, EntityType.Unit);

			Assert.AreEqual(_enemyEntity, _playerEntDetection.GetNearestAllyUnit());
		}
		...
		public IEnumerator When_AllyIsBuilding_Should_ReturnNull()
		{
			...
			Assert.AreEqual(null, _playerEntDetection.GetNearestAllyUnit());
		}
