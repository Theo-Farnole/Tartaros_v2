	...
	public class OptimizationWindow : EditorWindow
	{
		...
		private void OnGUI()
		{
			...
			else
			{
				...
				GUILayout.Label("{0} materials to fix.".Format(_materials.Length));
		...
		{
			Material[] materials = AssetDatabase.FindAssets("t:material", new string[] { "Assets/Arts", "Assets/Scenes" })
